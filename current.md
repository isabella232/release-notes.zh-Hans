...
# 内部审阅 - Adobe Experience Cloud 发行说明 - 2020 年 1 月
...
使用 Adobe ID，可以根据您的产品、所在的地区和事件首选项订阅状态事件通知。

| 功能 | 描述 |
| -----------| ---------- |
| 订阅实时电子邮件通知 | <ul><li>支持 Experience Cloud、Creative Cloud、Document Cloud、AEP 和 Adobe 服务</li><li>支持地区和事件类型首选项</li><li>对 Web、移动设备和平板电脑表面的 UX 支持</li></ul> |
| 通知首选项管理 | <ul><li>随时编辑和保存通知首选项</li><li>随时取消订阅通知</li><li>项目</li></ul> |
| 以个性化方式更快地发送电子邮件 | <ul><li>在打开、更新或关闭 CSO 和 CMR 后，立即发送事件通知</li><li>仅接收与您配置的首选项匹配的相关事件通知</li><li>收到的本地化通知基于帐户首选项中配置的语言</li></ul> |
