...
| 与 Adobe Analytics 集成 | Analytics现在包含Advertising Cloud DSP营销活动的“登录类型(AMO ID)”维度。  使用此维度根据访客登录网站的方式细分Analytics指标。 值包括“点进率”和“查看率”。<br><br/>**** 注意：2019年10月31日之前发生的浏览数据将显示为点进数据。 因此，我们不建议在2019年11月中旬之前将此维度与数据结合使用。 |
