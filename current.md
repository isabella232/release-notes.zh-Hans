...
>[!NOTE]
>
>若要接收有关此页面更新的电子邮件通知，请订阅每月的 [Adobe Priority Product Update](https://www.adobe.com/cn/subscription/priority-product-update.html)整月都在维护此页面，因此请定期回来查看 Adobe 企业产品和 Experience League 文档的更新。

最新更新日期：**2021 年 3 月 19 日**
...
* [Experience Platform 发行说明](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html)。(2021 年 2 月 24 日)
...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2021 年 3 月 16 日 | [更新用户档案操作](https://experienceleague.adobe.com/docs/journey-orchestration-learn/tutorials/building-a-journey/update-profile-action.html?lang=en#building-a-journey) | 视频 | 了解如何使用来自事件、数据源或使用特定值的信息更新现有Adobe Experience Platform用户档案。 |
...
| 2021 年 3 月 12 日 | [了解模式和XDM(针对Audience Manager用户的实时CDP)](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-schemas-xdm-for-aam-users.html?lang=en#other-integrations) | 视频 | 当您从Audience Manager转向实时客户数据平台（实时CDP）时，您将会遇到一些新概念和做法。 模式和XDM属于这一类别。 此视频介绍了这些概念。 |
| 2021 年 3 月 12 日 | [内容投放Experience Manager Cloud Service](https://experienceleague.adobe.com/docs/adobe-developers-live-events/events/content/feb2021/content-delivery.html#content) | 事件 | Adobe Experience Manager作为Cloud Service，具有强大的预配置内容投放体系结构。 演示如何充分利用优化的内容投放配置 |
| 2021 年 3 月 3 日 | [了解针对Audience Manager用户的实时CDP中的细分](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-segments-for-aam-users.html?lang=en#other-integrations) | 视频 | 当您从Audience Manager转向实时客户数据平台时，了解概念的差异会很有帮助。 此视频查看了Audience Manager和实时CDP之间在细分和细分创建方面的差异。 |
| 2021 年 3 月 3 日 | [了解Audience Manager用户实时CDP中的特点](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-traits-for-aam-users.html?lang=en#other-integrations) | 视频 | 当您从Audience Manager转向实时客户数据平台时，了解概念的差异会很有帮助。 此视频解决了Audience Manager中的特征和实时CDP中的等效内容。 |
| 2021 年 3 月 3 日 | [课程简介 — Audience Manager高级技能](https://video.tv.adobe.com/v/331788/?quality=12&learn=on) | 视频 | 视图此视频，了解Audience Manager Advanced Skills课程中的后续内容。 |
| 2021 年 3 月 3 日 | [了解面向Audience Manager用户的实时CDP中的第一方数据摄取](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-1pd-ingestion-for-aam-users.html?lang=en#other-integrations) | 视频 | 此视频讨论了使用Adobe Audience Manager的用户在实时客户数据平台(Real-time CDP)中的第一方离线数据摄取。 我们查看了两个产品之间在数据摄取方面的一些主要差异，并说明了在将进程移动到实时CDP之前，Audience Manager Data Connector如何用作停止间隙。 |
| 2021 年 3 月 1 日 | [通过提供Audience Marketplace，使您拥有的受众商业化](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/audience-marketplace/selling-data/commercialize-owned-audiences-on-marketplace.html?lang=en#audience-marketplace) | 视频 | 在此Audience Marketplace中，您将学习如何将数据设置为该视频上的私有或公共数据馈送，从而使您成为第2方或第3方数据的数据提供商。 |
| 2021 年 3 月 | [在Audience Manager中创建和管理激活](https://experienceleague.adobe.com/?recommended=AudienceManager-U-1-2020.4) | 课程 | 在本课程中，请了解有关“激活”受众的所有信息，即向目标合作伙伴发送受众数据，以便为最终用户定制体验。 您将学习目标的基础知识、如何根据您的需求选择正确的目标，以及如何基于人而非cookies准备受众数据并将其发送到社交网络目标。 |
...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2021年2月 | [使用AEM发布环境进行生产部署](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/production-deployment.html#graphql) | 教程 | 在本教程中，您将设置一个本地环境，以模拟从Author实例分发到Publish实例的内容。 您还将生成React App的生产版本，该应用程序配置为使用GraphQL API从AEM发布环境中使用内容。 在此过程中，您将学习如何有效使用环境变量以及如何更新AEM CORS配置。 |
| 2021年2月 | [使用GraphQL API进行无外设内容管理](https://experienceleague.adobe.com/?recommended=ExperienceManager-D-1-2020.1.headless) | 课程 | 在本课程中，您将探索如何使用AEM GraphQL API和无头功能来推动在外部应用程序中呈现的体验。 |
| 2021年2月 | [启动 — 功能视频](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/page-authoring/launches.html) | 视频 | AEM Sites中的启动提供了一种创建、创作和查看网站内容以供将来发布的方法。 在创建发布期间，生产网站可以继续发展，并像往常一样不断变化。 |
| 2021年2月 | [关联和取消关联资产 — 功能视频文本](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/authoring/relate-unrelate.html?lang=zh-Hans) | 视频 | 了解如何在AEM中建立和管理资产之间的关系。 |
| 2021年2月 | [从外部应用程序向 AEM 即云服务进行身份验证](https://experienceleague.adobe.com/?recommended=ExperienceManager-D-1-2020.1.aemcs) | 课程 | 在本课程中，您将学习外部应用程序如何使用本地开发访问令牌和服务凭据以编程方式通过HTTP验证到AEM作为Cloud Service。 |
| 2021年2月 | [在抵押贷款应用程序中填写和签署多个表单](https://experienceleague.adobe.com/?recommended=ExperienceManager-D-1-2020.7.forms) | 课程 | 使用AEM Forms和Sign集成对文档包进行无缝签名。 在表单中输入的数据可用于预填充包中的后续表单。 |
| 2021年2月 | [版本/ AEM中的时间扭曲](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/page-authoring/timewarp-feature-video-use.html) | 视频 | 时间扭曲是Adobe Experience Manager Sites的一项功能，它为作者提供了快速的方法来查看过去特定时间的页面状态。 |
| 2021年2月 | [基础 — 工作流管理](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/workflow/use-workflow-management.html?lang=en#workflow) | 视频 | 此视频使用工作流模型来演示这组功能，但它们也适用于AEM Launcher。 |
| 2021年2月 | [体验片段块](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/experience-fragments/building-blocks.html) | 视频 | 构造块是Experience Fragments的子功能。 构造块使内容作者能够跨不同的Experience Fragments变体重复使用组件。 |
| 2021年2月 | [工作流编辑器](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/workflow/use-the-workflow-editor.html?lang=en#workflow) | 视频 | 工作流支持Experience Manager中的业务流程管理，用于自动处理内容并促进需要人为决策的治理和流程。 |
| 2021年2月 | [AEM Assets中关闭的用户组](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/advanced/closed-user-groups.html) | 视频 | 关闭的用户组(CUG)是一项功能，用于限制对已发布站点上的选定用户组的内容访问。 此视频演示了如何将关闭的用户组与Adobe Experience Manager Assets一起使用以限制对特定资源文件夹的访问。 |
| 2021年2月 | [报表](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/advanced/asset-reports.html) | 视频 | AEM Assets提供了一个企业级报告框架，可通过直观的用户体验为大型存储库进行扩展。 |
| 2021年2月 | [使用AEM Assets为图像添加智能标签](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/metadata/image-smart-tags.html) | 视频 | 图像的智能标签可自动智能地根据图像内容向图像资源添加元数据标签，从而增强AEM搜索功能。 |
| 2021 年 2 月 24 日 | [元数据层叠，可见性](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/metadata/cascade-metadata-feature-video-use.html) | 视频 | 高级元数据管理允许用户创建层叠字段规则，以在AEM Assets中的元数据之间形成上下文关系。 以下视频演示了有关字段要求、可见性和上下文选择的新动态规则。 该视频还详细介绍了管理员将这些规则应用于自定义元数据架构所需的步骤。 |
| 2021 年 2 月 24 日 | [项目主页](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/projects/use-project-masters.html?lang=en#delete-project-masters) | 视频 | 删除主项目会导致派生项目不可用。 |
| 2021 年 2 月 24 日 | [自定义页面属性](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/developing/page-properties-technical-video-develop.html) | 视频 | 创建关于如何最好地扩展和自定义页面属性的技术视频。 |
| 2021 年 2 月 24 日 | [翻译内容片段](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/content-fragments/content-fragments-translation-feature-video-use.html) | 视频 | 了解如何使用Adobe Experience Manager本地化和翻译内容片段。 与内容片段关联的混合媒体资源也有资格被提取和翻译。 |
| 2021 年 2 月 24 日 | [体验片段](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/experience-fragments/experience-fragments-feature-video-use.html) | 视频 | Experience Fragments使内容作者能够跨渠道（包括网站页面和第三方系统）重复使用内容。 |
| 2021 年 2 月 24 日 | [增强的搜索提升](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/search-and-discovery/search-boost.html) | 视频 | 了解搜索提升。 |
...
| 发布日期 | 名称 | 解决方案 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2021 年 2 月 23 日 | [可交付性 — 可交付性指标](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/metrics-for-deliverability/metrics-overview.html) | Campaign Classic/Standard | 了解要监控的关键可交付性指标以及如何使用它们来识别声誉问题。 |
| 2021 年 2 月 23 日 | [可交付性 — 回弹](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/metrics-for-deliverability/bounces.html) | Campaign Classic/Standard | 了解不同类型的回弹。 |
| 2021 年 2 月 23 日 | [可交付性 — 投诉](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/metrics-for-deliverability/complaints.html) | Campaign Classic/Standard | 了解当用户指示电子邮件不需要或意外时注册的投诉。 |
| 2021 年 2 月 23 日 | [可交付性 — 垃圾邮件陷阱](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/metrics-for-deliverability/spam-traps.html) | Campaign Classic/Standard | 了解不同类型的回弹。 |
| 2021 年 2 月 23 日 | [可交付性 — 膨胀和阻塞](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/metrics-for-deliverability/bulking-and-blocking.html) | Campaign Classic/Standard | 了解ISP为何将电子邮件放在批量文件夹中或阻止它们。 |
| 2021 年 2 月 23 日 | [可交付性 — 过渡过程 — 基础架构](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/transition-process/infrastructure.html) | Campaign Classic/Standard | 了解正确构建电子邮件基础架构所需的内容。 |
...
| 2021 年 2 月 23 日 | [可交付性 — 过渡过程：定位条件](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/transition-process/targeting-criteria.html) | Campaign Classic/Standard | 了解如何在吸引参与度较低的受众之前，从实际操作中建立良好声誉，以有效建立信任。 |
| 2021 年 2 月 23 日 | [可交付性 — 过渡过程 — IP加温期间的ISP特定注意事项](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/transition-process/isp-specific-considerations-during-ip-warming.html) | Campaign Classic/Standard | 了解ISP提供商查看其流量的不同规则和方式 |
| 2021 年 2 月 24 日 | [可交付性 — 第一印象 — 简介](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/first-impressions/introduction.html) | Campaign Classic/Standard | 了解如何通过在这些方面留下良好的第一印象，为成功的电子邮件程序运行做好准备。 |
| 2021 年 2 月 24 日 | [可交付性 — 过渡过程：卷](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/transition-process/volume.html) | Campaign Classic/Standard | 了解发送量如何影响电子邮件营销活动的交付能力。 |
| 2021 年 2 月 24 日 | [可交付性 — 第一印象 — 地址收集和列表增长](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/first-impressions/address-collection-and-list-growth.html) | Campaign Classic/Standard | 了解新电子邮件地址的最佳来源、如何确保高数据质量并符合法律准则。 |
| 2021 年 2 月 25 日 | [可交付性 — 第一印象 — 欢迎电子邮件](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/first-impressions/welcome-emails.html) | Campaign Classic/Standard | 了解欢迎战略的关键要素。 |
| 2021 年 2 月 25 日 | [可交付性 — 过渡过程：切换电子邮件平台](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/transition-process/switching-email-platforms.html) | Campaign Classic/Standard | 了解如何在切换电子邮件平台时顺利过渡。 |
| 2021 年 2 月 26 日 | [可交付性 — 实现最佳可交付性的内容最佳实践](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/content-best-practices-for-optimal-delivery.html) | Campaign Classic/Standard | 优化电子邮件内容以实现交付的提示。 |
| 2021 年 2 月 26 日 | [可交付性 — 发件人永久性](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/sender-permanence.html) | Campaign Classic/Standard | 了解建立一致的发送卷为何非常重要。 |
| 2021 年 2 月 26 日 | [可交付性 — 持续监控](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/ongoing-monitoring.html) | Campaign Classic/Standard | 了解在监控交货时需要注意的问题。 |
...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2021 年 3 月 5 日 | [自定义Adobe Stock矢量插图中的颜色](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/customizecolors.html) | 视频 | 通过精美的插图为任何项目添加润饰效果。 在Adobe Stock中查找完美的矢量，然后使用Adobe Illustrator将颜色与项目调色板匹配。 |
| 2021 年 3 月 5 日 | [自定义Adobe Stock演示文稿模板，使其看上去专业而引人注目](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/presentationtemplate.html) | 视频 | 使用Adobe Stock的图像和模板以及一些简单易用的特殊效果，在几分钟内创建出精美的风格化演示文稿。 |
| 2021 年 3 月 5 日 | [使用Adobe Stock和XD自定义加载屏幕动画](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/loadingscreen.html) | 视频 | 从Adobe Stock自定义矢量图稿，为移动应用程序创建令人胆寒的加载屏幕动画。 |
| 2021 年 3 月 5 日 | [使用Adobe Stock图像创建逼真的复合照片](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/realisticcomposite.html) | 视频 | 将两张很棒的Adobe Stock照片汇集在一起，将人们吸引到您的社交帖子中。 |
| 2021 年 3 月 5 日 | [利用Adobe Stock，立即创建激发灵感的情绪板](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/moodboard.html) | 视频 | 创建项目情绪板，将信息、想法、视觉效果和调色板传递给团队/客户。 |
| 2021 年 3 月 5 日 | [使用优美的渐变效果和Adobe Stock资源创建有凝聚力的品牌形象](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/brandgradients.html) | 视频 | 使用Adobe Stock的可编辑矢量将动画引入新闻稿图形中。 |
| 2021 年 3 月 5 日 | [使用Adobe Stock和Photoshop创建电子邮件动画](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/animationemail.html) | 视频 | 借助Adobe Stock和Photoshop，通过停止动作动画增强您的电子邮件功能。 |
| 2021 年 3 月 5 日 | [使用Adobe Stock和XD创建交互式旅游照片](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/interactivetourismphoto.html) | 视频 | 使用Adobe Stock和XD在网站原型中快速创建交互式照片。 |
