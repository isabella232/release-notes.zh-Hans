...
* [发行说明](http://www.adobe.com/go/platform-release-notes-en)
...
* [Analytics 管理员的重要注意事项](#aa-notices)（更新日期：2020 年 4 月 16 日）
* [AppMeasurement](#appm)
...
| 功能 | 描述 |
| -----------| ---------- |  
| [预测受众](https://docs.adobe.com/content/help/zh-Hans/audience-manager/user-guide/features/algorithmic-models/predictive-audiences/predictive-audiences.html) | [!UICONTROL 预测受众]可以帮助您使用高级数据科学技术将未知受众实时分类为不同人物。<br><br>在营销环境中，人物是由访客、用户或潜在购买者定义的受众区段，他们具有一组特定特征，如人口统计信息、浏览习惯、购物历史记录等。<br><br>[!UICONTROL 预测受众]模型使这一概念更进一步，让您能够使用 Audience Manager 的机器学习功能，将未知受众分类为不同的人物。<br><br>Audience Manager 通过为一组已知的第一方受众计算未知的第一方受众的倾向，来帮助您实现这一目标。 |
| 其他[!UICONTROL 配置文件合并规则]增强功能 | [!UICONTROL 配置文件合并规则]使 Audience Manager 客户能够根据身份而不是设备定义、管理和激活受众区段。<br><br>从 4 月 29 日起，Audience Manager 客户将可以在 Audience Manager UI 的单个分段和批量报表中更好地了解特征和区段的设备和跨设备 ID 人口的细分情况。<br><br>这使得能够在 Audience Manager 内更好地分析身份，从而为客户提供按设备、人员和家庭划分的总区段人口的整体视图。此外，还将更新跨设备 ID 和设备 ID 的批量特征导出以反映这些增强功能。<br><br>特定更新包括： <ul><li>能够在[一般](https://docs.adobe.com/content/help/zh-Hans/audience-manager/user-guide/reporting/general-reports.html)和[趋势](https://docs.adobe.com/content/help/zh-Hans/audience-manager/user-guide/reporting/trend-reports.html)报表中针对[跨设备 ID](https://docs.adobe.com/content/help/zh-Hans/audience-manager/user-guide/reference/ids-in-aam.html) 进行报告。</li><li>增强了[区段生成器](https://docs.adobe.com/content/help/zh-Hans/audience-manager/user-guide/features/segments/segment-builder.html)中的[!UICONTROL 特征选择器]，包含以 [CRM ID](https://docs.adobe.com/content/help/zh-Hans/audience-manager/user-guide/reference/ids-in-aam.html) 作为关键字的特征人口；</li><li>能够创建以[跨设备 ID](https://docs.adobe.com/content/help/zh-Hans/audience-manager/user-guide/reference/ids-in-aam.html) 作为关键字的准确特征导出；</li><li>能够创建以[设备 ID](https://docs.adobe.com/content/help/zh-Hans/audience-manager/user-guide/reference/ids-in-aam.html) 作为关键字的准确特征导出（应排除已验证的特征）；</li><li>使用 [BAAAM](https://docs.adobe.com/help/zh-Hans/audience-manager/user-guide/reference/bulk-management-tools/bulk-management-intro.html) 工具请求时，能够返回与 [CRM ID](https://docs.adobe.com/content/help/zh-Hans/audience-manager/user-guide/reference/ids-in-aam.html) 关联的特征的正确计数。</li></ul> |
