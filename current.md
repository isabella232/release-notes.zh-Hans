...
* **[!UICONTROL Analysis Workspace ]**中的多个报表包：您现在可以将多个报表包中的数据并入一个[!UICONTROL Analysis Workspace]项目，以便在并排面板中查看。[了解更多...](https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/build-workspace-project/multiple-report-suites.html)
...
| 功能 | 描述 |
| -----------| ---------- |
| [批量管理工具工作表](https://docs.adobe.com/help/en/audience-manager/user-guide/reference/bulk-management-tools/bulk-management-intro.html) | 您可以使用工作表的新版本，它修复了某些客户在Windows 64位操作系统中创建算法模型时遇到的问题。 在此处下载最新 [版本](https://docs.adobe.com/help/en/audience-manager/user-guide/reference/bulk-management-tools/assets/BAAAM_V2_20200311.xlsm)。 |
