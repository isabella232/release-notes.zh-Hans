...
* 新的解决方案URL:所 `experience.adobe.com/<application name>.` 有产品最终都会采用此URL模式。 寻找新的URL以在月内生效。 Adobe建议在您看到重定向到新域后更新书签。
* 更轻松地在组织之间切换或切换到其他应用程序。
* 改进的产品帮助：Experience League  （体验联盟）已集成到产品中，因此帮助搜索还包括来自社区论坛和视频内容的结果。 此更改简化了对更多内容的访问，并有助于您充分利用Experience Cloud。 此外，单击“ **[!UICONTROL 帮助]**>**[!UICONTROL &#x200B;反馈]** ”，报告问题或与产品文档团队共享您的想法。
