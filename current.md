...
| 功能 | 描述 |
| -----------| ---------- |  
| [特征推荐](https://docs.adobe.com/content/help/en/audience-manager/user-guide/features/segments/trait-recommendations.html) | 由 [Adobe Sensei](https://www.adobe.com/cn/sensei.html) 提供支持的“特征推荐”功能可将数据科学融入到您的 Audience Manager 日常工作流程中。<br>使用“特征推荐”，在[区段生成器](https://docs.adobe.com/content/help/en/audience-manager/user-guide/features/segments/segment-builder.html)中构建或编辑区段时，您能够获得可包含的其他推荐特征（与区段规则中的特征类似）。将推荐的特征添加到区段中，可增加目标受众。 |
...
| 功能 | 描述 |
| -----------| ---------- | 
| 搜索促销活动 | 在日期范围选择器中，日历现在按照从星期日到星期六的顺序排列。以前，它是按照从星期一到星期日排列的。 |
