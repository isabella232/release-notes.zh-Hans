...
通过升级到新版 [Tableau](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_comproc.html)，我们更改了重叠报表的数据可视化方法。请参阅特质到特质重叠报表中的屏幕截图。请参阅 [特征与特征重叠报告](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_overlap_reports.html)。
...
通过升级到新版 Tableau，我们更改了重叠报表的数据可视化方法。请参阅区段到区段重叠报表中的屏幕截图。请参阅 [区段与细分重叠报告](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_segment_segment_overlap.html)
