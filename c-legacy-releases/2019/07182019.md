...
# Adobe Experience Cloud发行说明-2019年月
...
有关累积发行说明，请参阅 [Experience Cloud ID服务](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-release-notes.html) 。
...
* 更新 [了日志(X，B)](https://marketing.adobe.com/resources/help/en_US/insight/client/c_syntx_mtrc_exp.html) 计量语法文档的帮助定义。(AN-180527)
...
* Adobe Campaign Classic [19.1.2](https://docs.campaign.adobe.com/doc/AC/en/RN.html) -构建9029
