...
>[!NOTE]
>
>若要通过电子邮件接收有关即将发行的版本的通知，请订阅 [Adobe Priority Product Update](https://www.adobe.com/cn/subscription/priority-product-update.html)。您将在发布前三到五个工作日收到通知。 对于在版本发行之后发布的新信息，将使用发布日期进行标记。
...
有关累计的发行说明，请参阅 [Experience Cloud ID 服务](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-release-notes.html)。
...
通过 [AEM 6.5.1.0 更新](https://helpx.adobe.com/experience-manager/6-5/release-notes/sp-release-notes.html)或这篇[知识库文章](https://helpx.adobe.com/cn/experience-manager/kb/avoid-crx-quickstart-deletion-in-aem-6-5.html)，可以获取 AEM 6.5 clientlibs 缓存失效的重要 AEM 修补程序。
