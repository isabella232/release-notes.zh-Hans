...
* [[！DNL Launch，由Adobe提供(](https://docs.adobelaunch.com/) 链接到产品帮助)
...
### 用于：Chromecast、Roku、Apple TV和 [!DNL Launch] Web Extension {#aa-va}
...
* 修复了算法模型中的 **[!UICONTROL “选择全部]** ”复选框缺失 [](https://experiencecloud.adobe.com/resources/help/en_US/aam/trait-exclusion-algo-models.html) 页面中的“选择全部”复选框的错误。(AAM-42462)
