...
| 功能 | 描述 |
| -----------| ---------- |  
| [特征推荐](https://docs.adobe.com/content/help/zh-Hans/audience-manager/user-guide/features/segments/trait-recommendations.translate.html) | 由 [Adobe Sensei](https://www.adobe.com/cn/sensei.html) 提供支持的“特征推荐”功能可将数据科学纳入您的 Audience Manager 日常工作流程中。<br/>使用“特征推荐”，在[区段生成器](https://docs.adobe.com/content/help/zh-Hans/audience-manager/user-guide/features/segments/segment-builder.translate.html#create-segment)中构建或编辑区段时，您能够获得可包含的其他推荐特征（与区段规则中的特征类似）。将推荐的特征添加到区段中，可增加目标受众。 |
...
* 现在，[特征摘要页面](https://docs.adobe.com/content/help/zh-Hans/audience-manager/user-guide/features/traits/trait-details-page.translate.html)会显示特征类型。(AAM-25784)
...
* 修复了以下错误：在[选择要排除的特征](https://docs.adobe.com/content/help/zh-Hans/audience-manager/user-guide/features/algorithmic-models/trait-exclusion-algo-models.translate.html)页面，“算法模型”中缺少&#x200B;**[!UICONTROL 全选]**&#x200B;复选框。(AAM-42462)
* 修复了 Safari 浏览器上的以下错误：用户无法在“创建新数据源”页面中选中任何数据导出控件。(AAM-41178)

**新文档**

请参阅 [ID 监控和黑名单](https://docs.adobe.com/content/help/zh-Hans/audience-manager/user-guide/api-and-sdk-code/dcs/dcs-api-reference/id-monitoring-blacklisting.translate.html)，了解 DCS 如何监控其接收到的 ID，以及如何将那些在短时间内以异常高的速率发送的 ID 加入黑名单。
