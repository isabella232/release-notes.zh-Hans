...
| 管理员 &gt; 一般帐户设置 | 2019 年 2 月 7 日 | <ul><li>对于 2019 年 1 月之后在伦敦数据中心创建的所有新报表包，默认情况下都会启用设置_将 IP 地址的最后八位字节替换为 0_，但前提是这些报表包的设置复制自 Admin Console 中列出的模板。设置复制自其他报表包的报表包将继承选定报表包的所有设置。</li> <li>对于设置了报表包的所有 EMEA 客户，默认情况下将不再启用 _IP 模糊处理_设置。 </li></ul> |
