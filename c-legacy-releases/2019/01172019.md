...
# [!DNL Adobe Experience Cloud] 发行说明- 2019年1月
...
* [Target](https://marketing.adobe.com/resources/help/en_US/target/rn/target_release_notes.html) —— 指向解决方案帮助的链接
...
* [启动项](https://docs.adobelaunch.com/) -指向产品帮助的链接
* [ID 服务](#id-service)
...
在 8.1 中，我们通过 Google Tag Manager 使 DIL 符合更严格的安全策略。This version is only available from DTM and as standalone code, not [!DNL Launch] or AppMeasurement Audience Manager Module. 未来版本中将包括此更改。(CORE-24189)
