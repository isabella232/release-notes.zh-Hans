...
* [Target](https://marketing.adobe.com/resources/help/zh_CN/target/rn/target_release_notes.html) - 指向解决方案帮助的链接
...
有关 Mobile SDK 的更多信息，请参阅：[适用于 Experience 解决方案的 Android SDK 4.x](https://marketing.adobe.com/resources/help/zh_CN/mobile/android/) 和[适用于 Experience Cloud 解决方案的 iOS SDK 4.x](https://marketing.adobe.com/resources/help/zh_CN/mobile/ios/)。
...
在 8.1 中，我们通过 Google Tag Manager 使 DIL 符合更严格的安全策略。此版本只能通过 DTM 作为独立代码获取，不能从 [!DNL Launch] 或 AppMeasurement 受众管理模块获取。未来版本中将包括此更改。(CORE-24189)
...
有关更多信息，请参阅[常见问题解答](https://helpx.adobe.com/content/dam/help/en/experience-manager/support/adobe-oracle-java-license-agreement.pdf)。
...
当帐户、促销活动和广告组的元数据更改时，用于活动的促销活动的所有 s_kwcids（包括不再用于促销活动的 s_kwcids）将每天自动更新。以前，不会更新不再使用的 s_kw