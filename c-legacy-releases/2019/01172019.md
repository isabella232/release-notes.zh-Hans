...
* [[！DNL Launch，by Adobe]](https://docs.adobelaunch.com/) -链接到产品帮助
* [ID 服务](#id-service)
...
在 8.1 中，我们通过 Google Tag Manager 使 DIL 符合更严格的安全策略。此版本仅可从DTM提供，作为独立代码，不 [!DNL Launch] 可用作AppMeasurement受众管理模块。未来版本中将包括此更改。(CORE-24189)
