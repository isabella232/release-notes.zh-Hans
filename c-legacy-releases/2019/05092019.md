...
| **Ad Hoc Analysis：**&#x200B;与 Java 11 兼容 | 现在，Ad Hoc Analysis 已与 Java 11 兼容。Learn how to run [Ad Hoc Analysis on Java 11](https://marketing.adobe.com/resources/help/en_US/dsc/adhoc-java.html). |
| **数据收集：**&#x200B;新增的 s_ecid cookie | Added a new [first-party server cookie](https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/cookies-analytics.html), s_ecid, in which data collection stores the visitor's ECID. |
...
| 管理员 &gt; 一般帐户设置 | 2019 年 2 月 7 日 | * 对于 2019 年 1 月之后在伦敦数据中心创建的任何新报表包，默认情况下会启用“将 IP 地址的最后八位字节替换为 0”__&#x200B;设置，但前提是这些报表包的设置是从 Admin Console 中列出的模板复制的。设置复制自其他报表包的报表包将继承选定报表包的所有设置。<br/> * 对于设置了报表包的所有 EMEA 客户，默认情况下将不再启用“IP 模糊处理”__&#x200B;设置。 |
...
* [!DNL Campaign Classic] 18.10.4-构建8983
* [!DNL Campaign Classic] 18.10.5-构建8984
