...
| 管理员 &gt; 一般帐户设置 | 2019 年 2 月 7 日 | * 对于 2019 年 1 月之后在伦敦数据中心创建的所有新报表包，默认情况下都会启用设置&#x200B;_将 IP 地址的最后八位字节替换为 0_&#x200B;，但前提是这些报表包的设置复制自 Admin Console 中列出的模板。<br/> * 对于设置了报表包的所有 EMEA 客户，默认情况下将不再启用 &#x200B;_IP 模糊处理_&#x200B;设置。 |
