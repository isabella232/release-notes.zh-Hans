...
| 功能 | 描述 |
| -----------| ---------- |  
| **AppMeasurement版2.14.0** <ul><li>修复了当多个命中等待处理时，管理跟踪器参数状态的问题。(AN-176931、AN-176629、DTM-12758)</li><li>更新了 AppMeasurement 以包含 Visitor.js 4.3.0 (AN-180049)</li></ul> |
...
* 修复了影响 网页逗留时间的问题。在计算逗留时间分段时，Workspace 报表将不再使用“页面名称”，从而可以计算粒度和分段统计的网页点击数。(AN-140479)
...
了解如何利用最新的 AEM 技术实现 AEM Sites 代码库的现代化。[使现有Adobe Experience Manager Sites代码库现代化](https://expleague.azureedge.net/labs/L761/index.html)
...
* Campaign Classic 18.10.4 - 版本 8983
* Campaign Classic 18.10.5 - 版本 8984
...
[Primetime帮助主页](http://help.adobe.com/en_US/primetime/)
