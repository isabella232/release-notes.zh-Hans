...
[!DNL  Analytics] 客户在使用主营销配置文件并将声明的ID [传递给访客ID服务时，需](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_mmp.html) 要设置 [!DNL  Audience Manager] 集成代码 [](https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid_service.html)。 请参阅[配置文件合并客户支持](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_profile_merge_enablement.html)，了解详细信息。
