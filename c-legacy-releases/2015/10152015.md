...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>十月底推出的私有数据馈送选项让供应商可以控制购买者对其数据的访问。当提供商为特定客户提供特价优惠或其他专享优惠时，提供商可以将数据馈送设置为私有。请参阅<a href="https://marketing.adobe.com/resources/help/en_US/aam/c_audience_marketplace.html" format="https" scope="external">Audience Marketplace 文档</a>中的<span class="term">私有数据馈送</span>。(AAM-16621) </p> </td> 
  </tr> 
 </tbody> 
</table>
