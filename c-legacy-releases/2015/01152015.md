...
<table id="table_F042191E03D34D72BDC54DBDA4D38E17"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/mcloud/audience_library.html" format="https" scope="external">Marketing Cloud 受众</a>：您可以创建、编辑和管理受众，其方式与处理区段类似。您可以共享受众，以在 <span class="wintitle">Analytics</span>、<span class="keyword">Target</span> 和受众管理等解决方案中使用。 </p> </td> 
...
| 组件/功能 | 描述 |
|---|---|
| 数据仓库 | 在数据仓库报表中添加了对概要数据源的支持。这允许您报告Adobe Advertising Cloud中的搜索引擎(点击前)数据等指标。 |
