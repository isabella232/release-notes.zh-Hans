...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> 报告 <span class="wintitle"> 分析 </span> 导航更新 </td> 
   <td colname="col2"> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>注释：  </p> <p>1. 量度极性允许您指示在给定自定义事件(计量)发生时Adobe <span class="wintitle"> Analytics </span> 是否应考虑良好或不当。 </p> <p>2. 它将允许Adobe <span class="wintitle"> Analytics </span> 向各种指标显示定向指示符(箭头)以添加上下文(例如，每周比较一周)。示例：如果“已提交的错误”一周不断上升，Adobe <span class="wintitle"> Analytics </span> 是否应考虑好或坏？其他示例：“电子邮件注册数”呈上升趋势可能是好事。但“表单提交错误数”的上升可能是坏的。 </p> <p>在
