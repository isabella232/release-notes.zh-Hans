...
有关更多信息，请参阅 [Marketing Cloud 和核心服务](https://marketing.adobe.com/resources/help/zh_CN/mcloud/)产品文档。
...
>[!NOTE]
>
>从版本 14 开始提供的 Data Warehouse 访问功能将在本版本中删除。[了解更多](https://marketing.adobe.com/resources/help/zh_CN/reference/?f=whatsnew_segments)
...
有关更多信息，请参阅[配置数据馈送](https://marketing.adobe.com/resources/help/zh_CN/sc/clickstream/datafeeds_configure.html)。
...
请参阅 [AppMeasurement 发行历史记录](https://marketing.adobe.com/resources/help/zh_CN/sc/appmeasurement/release/index.html)，了解下列平台上 [!DNL  AppMeasurement] 的发行历史记录：
...
请参阅 [Adobe Target 发行说明](https://marketing.adobe.com/resources/help/zh_CN/target/rn/)，了解最新的日期和发行信息。
