...
Adobe 预计在 11 月至 12 月期间，我们的客户群会出现大量分类上传。我们将尽快处理这些上传工作，但是需要的处理时间可能比平常要长。有关最大程度缩短处理时间的提示，请参阅[分类处理时间](https://helpx.adobe.com/cn/analytics/kb/saint-processing-time.html)。
