...
* 修复了一个问题，该问题阻止在 [!DNL  Creative Cloud] 与和之间的注释中使用日文文本 [!DNL  Marketing Cloud]。
...
* 修复了 [!DNL  Target] 促销活动报表不在报告与分析中显示的问题。
* 修复了 [!DNL  Target] 促销活动名称中的特殊字符使其无法在报告与分析中报告的问题。
...
Social 15.5.1.0 版本 (2015/05/21) 包括以下更改：
...
| 功能 | 描述 |
|---|---|
| [受众市场](https://marketing.adobe.com/resources/help/en_US/aam/c_audience_marketplace.html) | [!DNL  Audience Marketplace] 提供专用功能，使数据购买者和数据提供商能以自助服务方式最小限度地执行数据交易。联系 [!DNL  Audience Manager] 您的顾问，开始学习。他们可以为 [!DNL  Audience Marketplace] 您激活。 |
