...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>自推出 SiteCatalyst 15 起，Reports &amp; Analytics 已不支持类型为“流量数据源”的数据源。数据源用户界面仍允许您创建流量数据源，但此类数据源只能应用于公司从SiteCatalyst 14迁移到SiteCatalyst 15之前的日期范围。 下个月（2015年6月）,Adobe计划删除流量数据源作为一个选项。 在 6 月份，我们还将在 Reports &amp; Analytics 中引入新的功能，通过该功能，您无需流量数据源，即可创建简单的流量量度。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_191B769A5A8A405C87A34245BE6B1127"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>2015年3月1日，Adobe Social停止了对推文地理定位的支持。 使用Twitter后，地理定位再次可用。 </p> 
