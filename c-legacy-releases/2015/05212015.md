...
请参阅以下 [ 发行历史记录](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html)，了解下列平台上 [!DNL  AppMeasurement]AppMeasurement 的发行历史记录：
...
<table id="table_3CA51E873E324FD4B7CF14190F127A77"> 
 ...
 <tbody> 
  <tr valign="top"> 
   <td colname="col1"> <p>Facebook </p> </td> 
   <td colname="col2"> <p>在Facebook上创建不显示在时间轴上但可通过直接链接访问的帖子。 通过此选项，内容创建者可创建要作为赞助（付费）广告进行推广的帖子。 </p> 
...
<table id="table_191B769A5A8A405C87A34245BE6B1127"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>2015年3月1日，Adobe Social不再支持推文的地理定位。 使用Twitter后，可再次使用地理定位。 </p> 
