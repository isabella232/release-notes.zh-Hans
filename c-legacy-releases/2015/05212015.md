...
有关此更改的信息，请参阅[访客 ID 服务实施](https://marketing.adobe.com/resources/help/zh_CN/mcvid/?f=mcvid_implement)。
...
<table id="table_3CA51E873E324FD4B7CF14190F127A77"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>当前，我们从社交网络收到了一些无法在 <span class="keyword">Adobe Analytics</span> 中报告的量度。新的保留事件允许您在 [!DNL Analytics] 中创建自定义报表以查看社交数据及 Web 数据。 </p> </td> 
  </tr> 
  <tr valign="top"> 
