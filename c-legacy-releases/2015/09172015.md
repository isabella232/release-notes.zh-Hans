...
对于解决方案管理员，请参阅[用户和群组](https://marketing.adobe.com/resources/help/zh_CN/mcloud/?f=user_mgmt_admin)，以了解有关将解决方案群组映射到更广泛的 Adobe 群组，以及在[企业功能板](http://adminconsole.adobe.html/#)中批量添加用户的重要信息。
...
请参阅 [Marketing Cloud 产品文档](https://marketing.adobe.com/resources/help/zh_CN/mcloud/)，以获取产品帮助。
...
<table id="table_D01BAD87E351453EA70A66B3B56F11F6"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>通过 <span class="keyword">Mobile Services</span> UI 将推送消息发送至 [!DNL Analytics] 区段，这允许您在与用户接触过程中利用强大的 [!DNL Analytics] 数据。 </p> <p>请参阅： </p> 
...
<table id="table_812AC7BF7F314540B7DA72D1C97D1918"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>当前提供两种 SDK（Android 和 iOS）的 4.6 版。 </p> <p>这两种 SDK 均包含以下改进： </p> <p> <b>将消息推送至 Analytics 区段：</b><span class="keyword">Adobe Mobile Services</span> 和 <span class="keyword">Adobe Mobile</span> SDK 允许您将推送消息发送至 [!DNL Analytics] 区段。此 SDK 还允许您轻松报告因打开推送消息而打开了您的应用程序的用户。 </p> <p> <b>客户赢取方法：</b>允许开发人员发起应用程序客户赢取促销活动，并假定用户已点击链接。这有助于您自行创建手动客户赢取链接并处理应用商店重定向。 </p> <p> <b>回传：</b>回传允许您将 SDK 收集的数据发送至单独的第三方服务器。利用您用来显示应用程序内消息的相同触发器和特征，可以配置 SDK 以将自定义数据发送至第三方目的地。 </p> <p> <b>标识符：</b>已添加以下新标识符： </p> 
...
Analytics 管理员：如果您是 Marketing Cloud 中的管理员，请参阅[用户和群组](https://marketing.adobe.com/resources/help/zh_CN/mcloud/?f=user_mgmt_admin)，以了解有关将 Analytics 群组映射到更广泛的 Adobe 群组，以及在[企业功能板](http://adminconsole.adobe.html/#)中批量添加用户的更新信息。
...
* 修复了在 Reports &amp; Analytics 中创建用户群组并将其选为默认用户群组之后发生的问题。将默认群组更改回“无”__的尝试失败，并出现一则错误消息。(AN-108270)
* 修复了“访客资料”&gt;“客户属性”报表无法在菜单中显示的问题。(AN-106265)
* 修复了导致用户屏幕在登录到 [!DNL  Analytics] 之后灰显的问题，此时登录页面上没有任何图表显示。(AN-105470)
* 修复了 Adobe Media Optimizer 数据馈送存在的一个问题。(AN-106116)
...
请参阅 [AppMeasurement 发行历史记录](https://marketing.adobe.com/resources/help/zh_CN/sc/appmeasurement/release/index.html)，了解下列平台上的 [!DNL  AppMeasurement] 发行历史记录：
...
* 已修订[通过像素调用捕获营销活动数据展示数据](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_capturing_camp_data.html)，在其中包含了 [!UICONTROL Advertising Analytics] 报表所需的新键值对。
* 已修订[通过像素调用捕获营销活动点击数据](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_capturing_camp_click_data.html)，在其中包含了 Advertising Analytics 报表所需的新键值对。
