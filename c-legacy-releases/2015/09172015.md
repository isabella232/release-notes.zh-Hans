...
<table id="table_D01BAD87E351453EA70A66B3B56F11F6"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>通过Mobile Services <span class="wintitle"></span><span class="keyword"></span> UI向Analytics区段发送推送消息允许您利用强大的[！DNL Analytics]数据，同时与用户互动。 </p> <p>请参阅： </p> 
...
* 修复了在报告与分析中创建用户群组并将其选为默认用户群组之后发生的问题。将默认群组更改回“无”__的尝试失败，并出现一则错误消息。(AN-108270)
