 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>历史上，数据馈送管理员必须依赖 Adobe 客户关怀才能获取其数据馈送作业的状态更新或更改其数据馈送。现在，数据馈送用户界面可供所有 Adobe Analytics 管理员使用。 </p> <p>使用 Analytics 数据馈送界面可以： </p> <p> 
     ...
     </ul> </p> <p>数据馈送服务名称已由<span class="term">点击流数据馈送</span>更改为 <span class="term">Analytics 数据馈送</span>。 </p> <p>请参阅 <a href="https://marketing.adobe.com/resources/help/en_US/reference/analytics-data-feed.html" format="https" scope="external">Analytics 数据馈送</a>以了解更多信息。 </p> </td> 
  </tr> 
  <tr> 
