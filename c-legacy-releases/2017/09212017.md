...
<table id="table_39E9A53B4A1A465589547638A29CB34C"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> (通过再营销目标Bing广告营销活动) Advertising Cloud支持以下各项： </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在AdWords Audience Target报告中，您现在可以包含Advertising Cloud跟踪的事务属性的列。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Bing Ads将于月25日开始将Advertising Cloud管理的帐户迁移到新的网站链接模型(共享网站)；流程预计需要天。月22日至完成帐户迁移期间，将无法在Advertising Cloud中访问Sitellink，并且将无法正确显示已删除的信息。如果您需要在迁移完成前对网站进行更改，请直接在Bing Ads编辑器中工作；所做的更改将迁移到新模型，并在迁移完成后由Advertising Cloud同步。支持共享站点链接的功能将在十月版中提供。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>搜索促销活动测试版 </p> </td> 
