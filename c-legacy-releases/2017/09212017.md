...
* 新增了[内容安全策略和 Marketing Cloud ID 服务](https://marketing.adobe.com/resources/help/zh_CN/mcvid/?f=mcvid-csp.html)文档，其中介绍了如何将对 ID 服务所使用的 Adobe 域发起的调用列入白名单。
...
* 修复了导致 [Audience Lab](https://marketing.adobe.com/resources/help/en_US/aam/?f=audience-lab.html) 无法及时加载的错误。(AAM-32249)
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Bing Ads 将在 9 月 25 日开始把 Media Optimizer 管理的帐户迁移到新的站点链接模型（共享站点链接），该过程预计要花费四天时间。从 9 月 22 日到帐户迁移完成这段时间，站点链接将无法在 Media Optimizer 中访问并将错误地显示为已删除。如果您需要在迁移完成之前对站点链接进行更改，请直接在 Bing Ads 编辑器中操作；您的更改将被迁移到新模型，并在迁移完成后由 Media Optimizer 同步。支持共享站点链接的功能将在十月版中提供。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>搜索促销活动测试版 </p> </td> 
