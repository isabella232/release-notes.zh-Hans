...
<table id="table_558E0B0AECB84969825705EC62FA1BB2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 移动App互动使用案例向您展示如何将您的移动App与Adobe Experience Cloud集成，以衡量用户参与度并为受众提供个性化体验。 </p> </td> 
  </tr> 
  <tr> 
...
有关 [产品文档](https://docs.adobe.com/content/help/zh-Hans/mobile-services/using/home.html) ，请参阅Adobe Mobile Services。 要查看以前版本的发行说明，请展开左侧窗格中的“历史发行说明”**。
...
Analytics客户可以使用标准Analytics功能和API（包括分类、数据源、处理规则和数据仓库导出）为ExactTarget实施自定义集成。 可以根据需要考虑与Adobe咨询团队的约定。
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>通过 Analytics 用户 ID 迁移，管理员可以轻松地将用户帐户从 Analytics“用户管理”迁移到 Adobe Admin Console。迁移用户后，他们将有权访问Experience Cloud中提供的解决方案和核心服务。 从本月晚些时候开始，将分阶段向客户实施迁移。 </p> <p> <a href="https://marketing.adobe.com/resources/help/zh_CN/experience-cloud/admin-console/analytics-migration/" format="https" scope="external">进一步了解 Analytics 用户 ID 迁移</a>。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col02"> <p>2017 年 9 月 21 日 </p> </td> 
   <td colname="col2"> <p>自2018年5月起，临时分析将仅支持Java 8或更高版本。 如果您在2018年5月维护版本发布后选择在Java 7上运行临时分析，Adobe将不再支持您的临时分析实施。 </p> <p>我们的。jar文件已使用安全的256位加密进行签名，低于1.7.0_76的Java版本不支持该加密。 此256位证书使我们能够为您提供增强的安全性。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>基于时间戳的维度已现成添加到Analysis Workspace。 维包括： </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>您现在可以一次更改多个列的设置。 只需选择多列，然后单击其中任一列的设置图标。 您所做的任何更改将应用于所有列，其中已选择单元格。 <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/column-settings.html" format="html" scope="external"> 更多... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> Adobe Analytics Cloud现在可以跟踪支持语音的智能助理（如Amazon Alexa、Google Assistant、Microsoft Cortana和Apple Siri）的性能。 </p> <p>请参阅<a href="https://marketing.adobe.com/resources/help/en_US/reference/voice-analytics-faq.html" format="html" scope="external">常见问题解答</a>。 </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7FBF4B0EBC384CCBA1640F06FA379EAA"> 
      <li id="li_EB0401D8344340209AF1AFEABE440A34"> 修复了导致使用“java_enabled”的区段无法正确处理数据仓库作业的问题。 (AN-147372) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
* 修复了更新的Audience Manager区段名称未发送到Google DFP目标的问题。 (AAM-31677)
...
<table id="table_7B50E9D0E6D340C1A589CE0713767285"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 通过此批量订阅增强功能，您现在可以通过工作流中的订阅服务活动直接在Adobe Campaign Standard数据库中存储订阅信息(来源和日期)。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>此版本为Dynamic Media客户提供新的自动化和投放功能，是第一个面向现有Dynamic Media Classic(S7)-AEM客户过渡到Dynamic Media的版本。 </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> 发布于 2017 年 9 月 12 日的 AEM 6.2 SP1-CFP7 是一项重要更新，其中包括自 2016 年 12 月推出 AEM 6.2 SP1 通用版本以来发布的多项关键客户修复。 </p> <p> 
     <ul id="ul_43836805FC5B4A5CA3CCD419B468D38D"> 
      ...
      <li id="li_88F67CEEAD374D29864302CD69159CEA"> <a href="https://helpx.adobe.com/cn/aem-forms/kb/aem-forms-releases.html" format="https" scope="external"> AEM 表单 CFP 版本 </a> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>自适应表单配置服务允许您根据用户的角色或功能限制规则编辑器对用户的访问。 </p> <p>请参阅<a href="https://helpx.adobe.com/aem-forms/6-3/rule-editor-access-user-groups.html" format="https" scope="external">为选定用户组授予规则编辑器访问权限</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>表单性能调整 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>表单开发人员可以将功能完备的自适应表单嵌入在AEM外部托管的外部网页中。 它帮助用户填写表单，而无需离开网页，并保留在页面上其他元素的上下文中。 </p> <p>请参阅<a href="https://helpx.adobe.com/aem-forms/6-3/embed-adaptive-form-external-web-page.html" format="https" scope="external">在外部网页中嵌入自适应表单</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p> 表单数据集成 </p> </td> 
   <td colname="col3"> <p>AEM Forms提供了一个配置包，您可以使用它将Dynamics 365与表单快速集成。 该软件包包括云服务配置和具有预配置的Dynamics 365实体和服务的表单数据模型。 </p> <p>请参阅 <a href="https://helpx.adobe.com/aem-forms/6-3/ms-dynamics-odata-configuration.html" format="https" scope="external">Microsoft Dynamics 365 OData 配置</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>安装和升级表单JEE </p> </td> 
   <td colname="col3"> <p>修复了AEM 6.3 Forms JEE的几个问题和更新的安装和升级文档。 </p> <p>请参阅左侧面板中<b>主题</b>下方的<a href="https://helpx.adobe.com/aem-forms/6-3/user-guide.html" format="https" scope="external">安装或升级 JEE 上的 AEM 表单</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>AEM Sites 6.3快速入门- WKND教程 </p> </td> 
   <td colname="col3"> <p>根据以下最新AEM技术，提供新的开发人员6.3快速入门教程： </p> <p> 
  ...
  <tr> 
   <td colname="col2"> <p> 使用客户端库的AEM Screens 6.3文档 </p> </td> 
   <td colname="col3"> <p>提供了新的AEM Screens 6.3文档。 或者，也提供快速入门，让用户在5分钟内创建数字标牌体验。 请参阅以下资源： </p> <p> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Bing Ads将于9月25日开始将Advertising Cloud管理的帐户迁移到新的Sitelink模型（共享Sitelinks）; 预计这个过程需要四天。 在9月22日到帐户迁移完成之间，Advertising Cloud中将无法访问网站链接，并将错误地显示为已删除。 如果您需要在迁移完成之前对网站链接进行更改，请直接在Bing Ads编辑器中工作； 迁移完成后，您的更改将迁移到新模型并由Advertising Cloud同步。 支持共享站点链接的功能将在10月份发布。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>搜索促销活动测试版 </p> </td> 
