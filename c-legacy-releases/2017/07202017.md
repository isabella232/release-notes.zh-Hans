...
有关 SDK 文档，请参阅[适用于 Marketing Cloud 解决方案的 Android SDK 4.x](https://marketing.adobe.com/resources/help/zh_CN/mobile/android/) 以及[适用于 Marketing Cloud 解决方案的 iOS SDK 4.x](https://marketing.adobe.com/resources/help/zh_CN/mobile/ios/)。要查看以前版本的发行说明，请展开左侧窗格中的“历史发行说明”**。
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>（包含设置“单日内对搜索建模并优化”的项目组合）现在，当 Media Optimizer 针对一天内的趋势更改竞价和促销活动预算时，会考虑收入数据。以前，只会考虑点击数据。 </p> <p>现在，在当天性能较好的时段，竞价会有所增加。 </p> </td> 
  </tr> 
  <tr> 
