...
有 [关SDK文档，请参阅适用于Marketing Cloud解决方案的Android](https://marketing.adobe.com/resources/help/zh_CN/mobile/android/) [SDK 4.x和适用于Marketing Cloud解决方案的iOS](https://marketing.adobe.com/resources/help/zh_CN/mobile/ios/) SDK 4.x。 要查看以前版本的发行说明，请展开左侧窗格中的“历史发行说明”**。
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_8C16C6ACD0B54F3CB097A5FC4C2E0FE6"> 
     <li id="li_57D83C770E6D4A7291A4DF790A8F9307">修复了有时会阻止投放包含2008年以前数据的细分报表的数据仓库问题(AN-143591)。 </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_9A3691CC67074D219596D9FF3B2474F5"> 
     ...
     <li id="li_05944EB2B35A4D2D9AF866F324DBD80C">报告API: 修复了在请求数据仓库报表时，度量ID为null的问题。 (AN-145354) </li> 
...
DIL 是适用于 Audience Manager 的 API 数据收集代码。7月版本将DIL增加到6.10版。此版本包含经过修订的代码，通过调用目标发布iFrame来提高效率，帮助降低CPU使用。 (MCID-419)
...
<table id="table_7B7CE5AD96FB4065805D0B1001B02E4B"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> 使用AEM的多语言活动 </p> </td> 
   <td colname="col2"> <p>一种独特的端对端解决方案，将AEM Sites中的内容创建、翻译和协作功能与活动中的多语言活动相结合，可解决营销人员在开展多语言电子邮件投放方面的运营难题。 </p> <p>通过多个参与者集中管理复杂的内容生命周期，自动创建多语言电子邮件，并通过一次单击发布获准内容以自动执行活动。 无论内容使用哪种语言，作为简化内容创建工作流程的一部分，确保您的品牌和信息一致，从而加快上市时间并提高ROI。 </p> <p>需要通过AEM提供Adobe Experience Manager和第三方机器或人文翻译服务。 有关更多信息，请参阅<a href="https://docs.campaign.adobe.com/doc/standard/en/ITG_Adobe_Experience_Manager_Creating_campaigns_and_emails_in_Experience_Manager_6.3.html" format="html" scope="external">详细的文档</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> 多语言投放（电子邮件和短信） </p> </td> 
   <td colname="col2"> <p>根据自动细分的客户首选语言，通过单一投放定义并执行多语言电子邮件和短信投放。 报告每个投放的性能，包括语言和各个级别。 </p> <p> 随着内容在国内外的发展，越来越多的公司面临着以多种语言提供内容的挑战。 因此，简化本地化消息投放是跨国公司有效客户沟通策略的关键部分； 公司在多语言国家／地区； 以及希望在语言级别进一步个性化其内容的公司，无论客户位于何处。 有关更多信息，请参阅<a href="https://docs.campaign.adobe.com/doc/standard/en/CHA_Email_messages_Creating_a_multilingual_email.html" format="html" scope="external">详细的文档</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Adobe Campaign通知 </p> </td> 
   <td colname="col2"> <p>直接在Adobe Campaign Standard中接收有关重要系统活动的通知。 例如，您将收到持续投放进度或工作流出错时的通知。 </p> <p>实时通知可让相关利益相关方及时获得信息，并让用户能够立即直接从应用程序内对活动通知采取行动。 团队效果是高级敏捷性、效率和更顺畅地执行活动。 有关更多信息，请参阅<a href="https://docs.campaign.adobe.com/doc/standard/en/ADM_Application_settings_Adobe_Campaign_notifications.html" format="html" scope="external">详细的文档</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> 投放警报 </p> </td> 
   <td colname="col2"> <p>除了直接在Adobe Campaign Standard中查看通知外，Adobe Campaign现在还提供电子邮件警报系统，以向重要系统活动的用户或外部利益相关者触发电子邮件警报。 创建、管理和接收可自定义的警报和仪表板，以跟踪投放成功或失败。 </p> <p> Adobe Campaign投放警报通过电子邮件和仪表板让所有相关Adobe Campaign用户在公司中自动获知投放执行状态，从而提高了效率。 有关更多信息，请参阅<a href="https://docs.campaign.adobe.com/doc/standard/en/SEN_Sending_and_tracking_messages_Monitoring_a_delivery.html#Delivery_alerting" format="html" scope="external">详细的文档</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> 数据源中的加密Declared ID </p> </td> 
   <td colname="col2"> <p>使用加密的联系信息（电子邮件地址或电话号码）作为Declared ID，发送电子邮件和短信触发器，无需活动中的现有用户档案。 由于加密的Declared ID可以由Adobe Campaign Standard解码，因此，当活动从包含先前未知联系人的其他Experience Cloud解决方案接收受众时，现在可以创建新的可销售用户档案。 </p> <p>目标客户和未知潜在客户通过电子邮件和短信实时提高现有客户群的忠诚度，并分别赢取新客户。 在潜在客户进行身份验证并在Adobe Campaign中利用这些洞察后，充分利用第一方cookie数据（来自Adobe Audience Manager*）。 </p> <p> *需要Adobe Audience Manager。 有关更多信息，请参阅<a href="https://docs.campaign.adobe.com/doc/standard/en/ITG_People_core_service_integration_About_People_core_service_Integration.html" format="html" scope="external">详细的文档</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> 将 KPI 从 Campaign 共享到 Analytics </p> </td> 
   <td colname="col2"> <p> 与Adobe Analytics共享活动数据，通过转化、统一点击前和点击后行为，衡量来自活动的电子邮件营销指标以及其他营销和广告工作。 </p> <p> 在Analytics中直接跟踪整体绩效并发现与外部项目的协同效应。 将您从这一整合视图中学到的知识重新应用于活动; 最终改进开放、点进和转化率，提高收入和整体活动表现。 </p> <p> 需要Adobe Analytics。 有关更多信息，请参阅<a href="https://docs.campaign.adobe.com/doc/standard/en/ITG_Adobe_Analytics_integration_About_Adobe_Analytics_integration.html" format="html" scope="external">详细的文档</a>。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>发布于2017年6月23日的AEM 6.3 CFP 6.3.0.1是一项重要更新，包含自2017年4月AEM 6.3正式发布以来发布的主要客户修复。 </p> <p> 
...
<!-- <draft-comment> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>想要了解即将召开的AEM Gem的最新信息，并询问AEM社区专家网络研讨会和本地AEM/Marketing Cloud/Experience Cloud用户组会议？ </p> <p>加入 <a href="https://www.meetup.com/AEM-Technologist-Group/" format="https" scope="external">AEM 技术专家小组*虚拟</a>即可获取世界各地在线活动和亲身参与活动的日程安排。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>（设置为“在日内建立模型并优化搜索”的包）Advertising Cloud现在在更改标书和活动预算以符合日内趋势时，会考虑收入数据。 以前，只会考虑点击数据。 </p> <p>现在，在当天性能较好的时段，竞价会有所增加。 </p> </td> 
  </tr> 
  <tr> 
