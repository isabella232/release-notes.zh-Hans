...
>[!IMPORTANT]
>
>The ID service code v2.0 automatically synchronizes IDs with [!DNL  Adobe Media Optimizer] by default. 另请参阅[了解 ID 同步和匹配率](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html)。
...
[!UICONTROL  DIL] 是用于API的API数据收集代码 [!DNL  Audience Manager]。月版本增加 [!UICONTROL  了DIL] 至6.8版本。
