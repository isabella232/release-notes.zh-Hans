...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>现在，您可以通过搜索 &gt; 产品，下载和显示 Bing Merchant Center (BMC) 帐户的数据。 您还可以将库存馈送模板与 BMC 帐户关联，以便将馈送列包含在购物促销活动的促销活动结构和广告副本中。 </p> <p>要直接在Advertising cloud中处理产品数据，您必须在Advertising cloud中创建相应的帐户记录，其中包含帐户访问凭据并启用了访问权限。 </p> <p>目前，在以下情况下支持使用 BMC 馈送： </p> <p> 
