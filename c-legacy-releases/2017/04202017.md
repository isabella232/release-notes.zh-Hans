...
<table id="table_7888822703184513A437A3CEFC599CAA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 在Analysis Workspace中，您可以应用“人员”量度来识别不同设备上的访客。 </p> <p>了解如何在 <a href="https://marketing.adobe.com/resources/help/zh_CN/mcdc/mcdc-people.html" format="html" scope="external">Adobe Marketing Cloud Device Co-op</a> 文档中获取“人员”指标的访问权限。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_0B70B5AEE69143D9A5FFA290478E845D"> 
      <li id="li_4188BBF771B4437AA5FF3240C46FB1D3">修复了在选定日期范围内未收集任何链接点击时出现的问题。 这导致活动图工具栏卡在挂起状态。 (AN-140163、AN-140119、AN-136186) </li> 
...
* 将区段 API 的方法迁移到 Swagger。请参 [阅Audience Manager API代码迁移](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html)。 (AAM-28601)
* 为DAID目标删除了可寻址受众中的几个小的可视错误。 (AAM-28679)
* 修复了“用户管理”页面中的一个问题，该问题导致当客户尝试使用已使用的用户名为公司创建新用户时，不显示错误消息。 (AAM-28945)
* 修复了在密码重置模式、受众市场和跨用户界面的列表页面的排序列中显示错误图标的可视错误。 (AAM-28953)
...
Adobe发布了 [Adobe Campaignv6](https://helpx.adobe.com/security/products/campaign/apsb17-09.html) .11的Windows和Linux安全公告。
...
<table id="table_B8FB3E741CFF4C3AA561C191182484ED">
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>您现在可以访问以Creative SDK为后盾的一整套功能，在编辑电子邮件或登陆页时直接在内容编辑器中增强您的图像。 </p> <p> 此功能不需要购买其他Creative Cloud解决方案。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> Amazon Simple存储服务(S3)连接器 </p> </td> 
   <td colname="col2"> <p> Amazon Simple存储服务(S3)连接器现在可用于将数据导入或导出到Adobe Campaign。 可以在工作流活动中设置。 配置在外部帐户中完成。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Dreamweaver实时集成 </p> </td> 
   <td colname="col2"> <p>Adobe Campaign与Dreamweaver之间的集成现已实现。 它现在可与Dreamweaver(17.0.2)的最新正式发布版本配合使用。 </p> <p>要求通过 <a href="https://adobe.ly/acdw_addon" format="http" scope="external">Adobe 附加组件</a>，安装 Adobe Campaign 集成的扩展功能。 </p> <p> 您可以查看 <a href="https://docs.campaign.adobe.com/doc/standard/en/Videos/ACS_Dreamweaver.mp4" format="mp4" scope="external">Dreamweaver 与 Adobe Campaign Standard 集成</a>视频，以了解更多信息。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>从Advertising Cloud到Analytics的新版反向数据馈送可显着提高数据准确性。 在未来几周内，所有与Analytics集成的广告商都将升级为新的反向信息源。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>您现在可以使用电子邮件受众或现有Adobe Experience Cloud受众的细分创建Google列表(搜索广告的再营销列表): </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      ...
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Adobe Audience Manager细分： （仅限允许列出的广告商的测试版）来自活动测试版&amp;gt; 受众&amp;gt; 受众，您可以从将Advertising Cloud作为目标的任何Audience Manager区段创建基于Google网站标签的受众。 这可能包括发布到Adobe Experience Cloud的Adobe Analytics细分，以及使用People核心服务在Adobe Experience Cloud中创建的细分。 Advertising Cloud将自动将Google跟踪URL推回Audience Manager区段，以便Google可以跟踪受众。 </li> 
     </ul> </p> <p>Advertising Cloud不存储用于创建或编辑Google列表的电子邮件受众或Audience Manager区段中的任何客户数据。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>搜索促销活动测试版 </p> </td> 
   <td colname="col2"> <p>（仅允许列出广告商的Beta版本）在发布后的一周内将提供新的“搜索测试版”用户界面，其中： </p> <p> 
     <ul id="ul_4D73AB12C2524DD4B0D72AFF1EC5FC0B"> 
      ...
      <li id="li_649DA70ACC7A4A46B2EF91C9C028DE26">受众菜单，包含库、目标和排除。 该库列表了您的所有Google受众(再营销列表)，您可以使用Adobe Audience Manager中的细分创建Google受众。 您可以将Google活动中的任何受众用作广告组级别目标、活动和广告组级别排除。 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
