...
您可以了解 2017 年 Adobe 峰会期间更多有关 [Adobe Experience Cloud](https://www.adobe.com/experience-cloud.html) 方面的公告。
...
* 我们已经改进了“配置文件链接”功能。由于群集中共有 4 个 [Audience Manager UUID](https://marketing.adobe.com/resources/help/en_US/aam/ids-in-aam.html)，所以该功能如今可以将一个 Audience Manager UUID 与其他三个 Audience Manager UUID 链接在一起。(AAM-28808)
...
Adobe 发布了一个适用于 Windows 和 Linux 的 [Adobe Campaign 安全公告](https://helpx.adobe.com/security/products/campaign/apsb17-09.html)。
