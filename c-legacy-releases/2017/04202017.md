  ...
  <tr> 
   ...
   <td colname="col2"> <p>您现在可以使用电子邮件受众或现有Adobe Experience Cloud受众的细分创建Google列表(搜索广告的再营销列表): </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      ...
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Adobe Audience Manager细分： （仅允许广告商使用的测试版）来自活动Beta &amp;gt; 受众&amp;gt; 受众，您可以从将Advertising Cloud作为目标的任何Audience Manager区段创建基于Google网站标签的受众。 这可能包括发布到Adobe Experience Cloud的Adobe Analytics细分，以及使用People核心服务在Adobe Experience Cloud中创建的细分。 Advertising Cloud将自动将Google跟踪URL推回Audience Manager区段，以便Google可以跟踪受众。 </li> 
     </ul> </p> <p>Advertising Cloud不存储用于创建或编辑Google列表的电子邮件受众或Audience Manager区段中的任何客户数据。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>搜索促销活动测试版 </p> </td> 
   <td colname="col2"> <p>（仅允许广告商使用的测试版）新的搜索测试版用户界面将在发布后的一周内发布，其中： </p> <p> 
