...
Learn more about the [Adobe Experience Cloud](https://www.adobe.com/cn/experience-cloud.html) announcement at the 2017 Adobe Summit.
...
<table id="table_7888822703184513A437A3CEFC599CAA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 在Analysis Workspace，您可以应用“人员”指标来识别不同设备上的访客。 </p> <p>了解如何在 <a href="https://marketing.adobe.com/resources/help/zh_CN/mcdc/mcdc-people.html" format="html" scope="external">Adobe Marketing Cloud Device Co-op</a> 文档中获取“人员”指标的访问权限。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>“人员”模板 </p> </td> 
   <td colname="col2"> <p>注意：“人员”模板及其关联的“人员”量度只能在 <a href="https://marketing.adobe.com/resources/help/zh_CN/mcdc/mcdc-people.html" format="html" scope="external">Adobe Marketing Cloud Device Co-op</a> 中使用。 </p> <p>模板基于“人员”量度，它是“唯一访客”量度的消除重复版本。 “人员”指标衡量使用多种设备的消费者与您的品牌互动的频率。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nielsen Joint SDK于2017年3月20日发布。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在 2017 年 4 月 20 日之前，所有用户（包括管理员）都必须通过测验，然后才能获得 Adobe 客户关怀赋予的使用处理规则的授权。 </p> <p>当前，管理员<b>默认</b>拥有使用处理规则的权限。考试不再必要。 管理员还可以通过管理工具界面向非管理员授予这些权限。 <a href="https://marketing.adobe.com/resources/help/zh_CN/reference/processing_rules.html" format="html" scope="external"> 更多... </a></p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_8A8B70BF95EE4E9D895043277974ED74"> 
     ...
     <li id="li_BBB9F3D8177A4FB1B0E66FA053E02F79">修复了在尝试创建区段时导致仅日语错误的问题。 (AN-139916) </li> 
     <li id="li_9424DBAF511C4273AC52EF4016697E3C">修复了由于时区不是最新状态，导致警报触发错误的问题。 (AN-134390) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
     ...
     <li id="li_3067A6CC3B6544DDA2D0307E68EFC501">修复了按维划分%度量时发生的问题。 关联维度的度量结果是小数而不是百分比。 (AN-141122) </li> 
     <li id="li_8891C6DDFDE847BD9E6AE4D4A8D8D525">修复了在 <span class="wintitle">工作区</span> 中打开项目却不显示任何内容的问题。（AN-141053、AN-140943） </li> 
     <li id="li_65CC26F8EA214077B10BE18906958E02">修复了在链接到细分单元格时，折线图重新加载并显示不可读信息的问题。 (AN-140057) </li> 
     <li id="li_4A3BE5EF95364A328026845ED6EC7FC5">修复了已保存但未显示的细分的问题。 (AN-139984) </li> 
     ...
     <li id="li_35D4F40C41414D5F82398C3CFA54EB1D">修复了时间格式的计算量度无法显示正确信息的问题。 (AN-139688) </li> 
     ...
     <li id="li_7C5BD4DD52204E589364EB2BBE904814">修复了导致对计划工作区进行任何更改以触发发送给收件人的电子邮件的问题。 (AN-131167) </li> 
     <li id="li_B7D4FB84083F43949039D8E714D3D7BC">修复了报表包显示错误货币的问题。 (AN-126230) </li> 
     <li id="li_F7D90FC5E62F4FCBB3FAFFC23637B3EA">修复了阻止通过电子邮件共享。pdf或。csv报告的问题。 (AN-125437) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      <li id="li_09FB915FD48F476BAEC68102C2C56D40">修复了共享指向报表的链接，然后将报表类型更改为趋势／排名时“找不到页面”错误的问题。 (AN-133515) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BB3A5CC8E3D84478B8358145E7CD7CF0"> 
      <li id="li_50F784B717AA4B0EB56823BEE7BDB9F1">修复了使用日维时发生的日期范围问题。 (AN-139559) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BCA85EDE14C2445C8C10BDD77ED342A6"> 
      <li id="li_FD1E9A3A72564BE293BBAF1BD13A0339">修复了分配给请求的报表包标签无法更新的问题。 (AN-139276) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_0B70B5AEE69143D9A5FFA290478E845D"> 
      <li id="li_4188BBF771B4437AA5FF3240C46FB1D3">修复了在选定日期范围内未收集任何链接点击时出现的问题。 这导致Activity Map工具栏卡在挂起状态。 (AN-140163、AN-140119、AN-136186) </li> 
      <li id="li_D13B073DBDCB4E1780B9BC04ED01BA65">修复了无法加载法语版 <span class="keyword">Activity Map</span> 的问题。(AN-139773) </li> 
      <li id="li_AB99880B33E7451BA5DB26F46DA816BF">修复了在某些 Web 页面上，页面加载中加载 Analytics 标签的时间导致了竞争状态，进而阻止 <span class="keyword">Activity Map</span> 在登录后正确初始化的问题。除非用户刷新网页登录后，此问题将阻止应用程序显示叠加。 (AN-139325) </li> 
      <li id="li_A4A1CD597F5A49A797C4CA4513598E4D">修复了气泡叠加定位不正确的问题。 （AN-131969、AN-124094） </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Video Analytics </p> </td> 
   <td colname="col2"> <p>除了现有的处理规则，即使： </p> <p> 
     ...
     </ul> </p> <p>这些更新位于视频分析处理服务中，不需要对播放器实施或分析报告进行更改。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_A50E675542D94AB3B1206ECAC3C39BC8"> 
      <li id="li_A5C2F2B605694CE6B31BF547D7E15462"> 修复的细分问题： 
       <ul id="ul_8FA1BE67BC124B4CBE56327F16C11BA6"> 
        <li id="li_4595D1ABE37C48B0976B3232CC4D6ADB">从段规则字符串中修剪的空白(AN-140432)。 </li> 
        <li id="li_2DB5D7A7EE77439AB22DACB02FAC8038">添加了“NOT CONTAINS ONE/ALL”运算符中缺少的修剪。 </li> 
       </ul></li> 
      <li id="li_94115FD800EF4DF891D0AF616CE8AD83">修复了嵌套访问/访客段过滤(AN-116275)中的错误。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b> <span class="keyword"> JavaScript AppMeasurement</span></b> </p> <p>版本 2.1.0 </p> 
    <ul id="ul_80BCF27E492246AD883ABD5B417004E1"> 
     ...
     <li id="li_CB1E4CAC306B473FBFC2E50B440568B1"> 重新包含访客API 2.1.0。 (AN-140873) </li> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>我们改进了搜索和筛选特征时的UI。 更多信息，请参阅<a href="https://marketing.adobe.com/resources/help/en_US/aam/c_tb_dashboard.html" format="https" scope="external">特征功能板</a>文档。 </p> </td> 
  </tr> 
  <tr> 
...
* 修复了在将URL映射到URL目标时，对于某些客户，将不会保存完整URL字符串的问题。 (AAM-28510)
* 修复了RBAC用户用户档案合并规则中的一个问题，该问题导致对视图特征没有权限的用户显示空白页面，而不是显示他们无权视图该页面的警告消息。 (AAM-28361)
* 修复了对于某些客户，“特征列表”页面包含指向数据源的中断链接的问题。 (AAM-29174)
* 我们改进了用户档案链接功能。 The feature now links an [Audience Manager UUID](https://marketing.adobe.com/resources/help/en_US/aam/ids-in-aam.html) to another three Audience Manager UUIDs, for a total of 4 Audience Manager UUIDs in a cluster. (AAM-28808)
...
* 将区段 API 的方法迁移到 Swagger。See [Audience Manager API Code Migration](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html). (AAM-28601)
* 为DAID目标删除了可寻址受众中的几个小的可视错误。 (AAM-28679)
* 修复了“用户管理”页面中的一个问题，该问题导致当客户尝试使用已使用的用户名为公司创建新用户时，不显示错误消息。 (AAM-28945)
* 修复了一个视觉错误，该错误导致在密码重置模式、Audience Marketplace和列表页面的排序列中显示错误的图标。 (AAM-28953)
* 修复了Audience Manager管理员界面中无法将Audience Marketplace最终用户ID添加到公司的问题。 (AAM-28953)
...
* Publish Anywhere:修复了照片或视频上传超过某个平台API大小限制时用户不会收到警告的问题。
* Publish Anywhere:修复了Facebook上的目标相册帖子在未发布照片的情况下发布的问题。
* 内容日历：修复了用户无法编辑计划子帖子的时间的问题。
* 内容日历：修复了将视频发布到Twitter时表情图标和文本未显示的问题。
* 报告：修复了下载审核概述报告时产生错误的问题。
* Facebook属性详细信息：修复了按地理位置获取Facebook属性粉丝的问题。
* 协调：修复了用户无法为属性或作者编写多行注释的问题。
* 协调：修复了“作者详细信息”页面未显示与该作者交互的完整历史记录的问题。
...
Adobe发布了 [Adobe Campaignv6](https://helpx.adobe.com/security/products/campaign/apsb17-09.html) .11（Windows和Linux）的安全公告。
...
<table id="table_B8FB3E741CFF4C3AA561C191182484ED">
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>您现在可以访问以Creative SDK为后盾的一整套功能，在编辑电子邮件或登陆页时直接在内容编辑器中增强您的图像。 </p> <p> 此功能不需要获取其他Creative Cloud解决方案。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> 事务型推送通知 </p> </td> 
   <td colname="col2"> <p> 移动应用渠道已添加到Adobe Campaign的事务消息传递功能中。 现在支持三种渠道事务性消息:电子邮件、短信和推送通知。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> 循环推送通知 </p> </td> 
   <td colname="col2"> <p> 您现在可以在工作流中使用循环推送通知。 循环通知使您能够多次将同一移动应用推送通知投放发送到同一目标或以特定频率（每日、每月等）发送到动态受众。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Amazon简单存储服务(S3)连接器 </p> </td> 
   <td colname="col2"> <p> Amazon简单存储服务(S3)连接器现在可用于导入或将数据导出到Adobe Campaign。 可以在工作流活动中设置。 配置在外部帐户中完成。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Dreamweaver集成实况 </p> </td> 
   <td colname="col2"> <p>Adobe Campaign和Dreamweaver的融合现已实现。 它现在与官方上次发布的Dreamweaver版(17.0.2)配合使用。 </p> <p>要求通过 <a href="https://adobe.ly/acdw_addon" format="http" scope="external">Adobe 附加组件</a>，安装 Adobe Campaign 集成的扩展功能。 </p> <p> 您可以查看 <a href="https://docs.campaign.adobe.com/doc/standard/en/Videos/ACS_Dreamweaver.mp4" format="mp4" scope="external">Dreamweaver 与 Adobe Campaign Standard 集成</a>视频，以了解更多信息。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>最新推荐的AEM Oak累积修复包可在以下位置获得： </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> <b>MMERSE17 将于 2017 年 5 月 15 日至 19 日召开</b> </p> <p>IMMERSE 是 AEM 全球开发人员虚拟会议。 </p> <p> <b>请立即注册</b>，参加我们的第二届年度 AEM 全球开发人员虚拟会议。包括每天在印度标准、英国夏令时和太平洋夏令时区进行五次会议。 我们增加了一个展厅，羽毛之鸟圆桌讨论会和网络休息室。 您可以在办公室或家中舒适地参加，具体取决于您所在的位置。 <a href="https://docs.adobe.com/dev/products/aem/events/0416.html" format="https" scope="external"> 了解更多 </a>信息。 </p> <p>您是否积极参与AEM开发人员社区？ 您的公司是否希望被视为社区的主要支持者？ 请查看我们的 <a href="https://files.acrobat.com/a/preview/a2b82990-996a-47a2-aeed-909189ecb159" format="https" scope="external">IMMERSE17 赞助招股说明书</a>，以参与这个生机勃勃的社区。 </p> <p>使用促销代码 <span class="codeph">Bz648</span>，可享有 $50.00 美元的打折优惠。团体票可供 10 人或 10 人以上的与会者使用。若要了解更多信息，请将电子邮件发送至 Charlie Shafton (<span class="codeph">eci77283@adobe.com</span>)。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>向 AEM 社区专家提问 </p> </td> 
   <td colname="col3"> <p> 请您于 2017 年 4 月 25 日美国山地标准时间 (MST) 上午 9：00-10：00，同 AEM 社区超级用户、2015-2016 年度社区成员 Lokesh BS 一起，讨论有关“在 Experience Manager 中使用 Bootstrap 和 Angular JS 构建响应式布局”这一主题"。 </p> <p>您将学习AEM开发技术，这些技术可以应用到AEM项目。 洛凯什将提供演示并回答您的问题。 作为AEM开发人员，这是您不想错过的会话。 您可以在此执行 <a href="https://communities.adobe.com/content/usergenerated/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/_jcr_content/par/calendar/ask_the_aem_communit_7.form.html/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/upcoming-event-detail" format="https" scope="external">RSVP</a>。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>从Advertising Cloud到Analytics的新版反向数据馈送可显着提高数据准确性。 在未来几周内，所有与Analytics集成的广告商都将升级到新的反向信息源。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>搜索 </p> </td> 
   <td colname="col2"> <p>您现在可以使用电子邮件受众或现有Adobe Experience Cloud列表的细分创建Google列表(搜索广告的再营销受众): </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      <li id="li_B56CA061540B4414861918CAFCB81397">Adobe Campaign电子邮件列表:您的客户经理将帮助您设置一个工作流，以从活动内的电子邮件列表创建和更新Google客户受众。 </li> 
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Adobe Audience Manager分部：(仅面向列入允许列表活动广告商的测试版)来自测试版&amp;gt;受众&amp;gt;受众，您可以从以Advertising Cloud为目标的任何Audience Manager区段创建基于Google网站标签的受众。 这可能包括发布到Adobe Experience Cloud的Adobe Analytics细分，以及使用人员核心服务在Adobe Experience Cloud创建的细分。 Advertising Cloud将自动将谷歌跟踪URL推回Audience Manager区段，以便谷歌能够跟踪受众。 </li> 
     </ul> </p> <p>Advertising Cloud不存储电子邮件列表或Audience Manager区段中用于创建或编辑Google受众的任何客户数据。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>搜索促销活动测试版 </p> </td> 
   <td colname="col2"> <p>(仅列入允许列表限测试版广告商)发布后一周将提供新的搜索测试版用户界面，包括： </p> <p> 
     <ul id="ul_4D73AB12C2524DD4B0D72AFF1EC5FC0B"> 
      ...
      <li id="li_649DA70ACC7A4A46B2EF91C9C028DE26">受众菜单，包含库、目标和排除。 图书馆列表您的所有Google受众(再营销列表)，您可以使用Adobe Audience Manager的细分创建Google受众。 您可以将Google活动中的任何受众用作广告组级别目标、活动和广告组级别排除。 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>搜索高级促销活动管理 (ACM) </p> </td> 
   <td colname="col2"> <p>必应广告文本广告模板包括新的广告组级语言设置。 </p> </td> 
  </tr> 
  <tr> 
