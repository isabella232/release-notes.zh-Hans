...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>从Advertising Cloud反向数据馈送的全新版本大幅提高了数据准确性。未来几周内，所有配备 Analytics 集成的广告客户都将升级到新的反向数据馈送。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>现在，您可以创建（为了搜索广告而重复销售列表的）Google 受众，具体方法是：使用来自现有 Adobe Experience Cloud 受众的电子邮件列表或区段： </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      ...
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Adobe Audience Manager细分：(仅适用于列入白名单的广告商的测试版)从营销活动Beta&amp; amp开始；gt；受众和受众；gt；受众，您可以从具有Advertising Cloud作为目标的任何Audience Manager细分中创建基于Google网站标记的受众。这其中可能包括发布到 Adobe Experience Cloud 中的 Adobe Analytics 区段，以及使用“人员”核心服务在 Adobe Experience Cloud 中创建的区段。Advertising Cloud会自动将Google跟踪URL推送回Audience Manager细分，以便Google能够跟踪受众。 </li> 
     </ul> </p> <p>Advertising Cloud不会存储您的电子邮件列表或用于创建或编辑Google受众的Audience Manager区段中的任何客户数据。 </p> </td> 
  </tr> 
  <tr> 
