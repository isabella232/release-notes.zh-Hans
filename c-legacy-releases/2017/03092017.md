...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>“自动优化竞价调整”选项允许Advertising Cloud在优化作品集时自动更改个人信息中广告组的竞价设置，以优化性能。Advertising Cloud可以优化Google、Bing和Yahoo！日本移动设备目标、Google 和 Bing 平板电脑与计算机目标、Google RLSA 目标以及 Google 定位目标，优化竞价调整。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>（拥有最终 URL 的 Bing 商业中心帐户）“跟踪模板”字段可供“Bing 购物”模板和批量表格中的产品组使用。 </p> <p>对于Advertising Cloud转换跟踪，如果您在帐户、营销活动或广告组级别具有跟踪模板，则无需输入值。 </p> </td> 
  </tr> 
  <tr> 
