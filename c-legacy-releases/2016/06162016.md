...
>[!IMPORTANT]
>
>现在，访问 [!DNL  Target] 功能 [!DNL  Mobile Services] 需要用户使用为 [!DNL  Target] 其公司提供的Adobe ID登录。通过 [!DNL  Target] 用户名和密码登录的功能已被删除。
...
* 修复了已删除的用户在 * 的特定属性中依然被列为 ` authorizers`*[!DNL  Social] 的问题。(AS-37219)
