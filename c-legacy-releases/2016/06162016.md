...
<table id="table_D919A080718349AA83775BEB256B7C4A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>ID 服务会对从服务器返回的 MID 值进行编码，或者当 MID 值由 <span class="codeph">visitor.setMarketingCloudVisitorID()</span> 函数设置时，也会进行编码。有关 MID 的详细信息，请参阅 <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid_cookies.html" format="https" scope="external">Cookie 和 Marketing Cloud ID</a>。(AAM-23336) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* [通过像素调用捕获营销活动展示数据](https://marketing.adobe.com/resources/help/en_US/aam/?f=c_doc_updates.html)
* [测试版环境](https://marketing.adobe.com/resources/help/en_US/aam/?f=beta_environment.html)
...
* 修复了已删除的用户在 [!DNL  Social] 的特定属性中依然被列为 *`authorizers`* 的问题。(AS-37219)
