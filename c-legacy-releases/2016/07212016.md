...
有关 [产品文档](https://marketing.adobe.com/resources/help/zh_CN/mobile/) ，请参阅AdobeMobile Services。 要查看以前版本的发行说明，请展开左侧窗格中的“历史发行说明”**。

### 动态标签管理 {#dtm}

| 功能 | 描述 |
|---|---|
| Marketing CloudID服务工具 | 现在，默认情况下启用在页面顶部加载DTM中的Marketing CloudID服务工具的选项。 |
...
另请参阅 [Marketing Cloud ID 服务](https://docs.adobe.com/content/help/zh-Hans/id-service/using/home.html)产品文档。
  ...
  <tr> 
   ...
   <td colname="col2"> <p>2016 年 10 月，Analytics 管理员将可以在<span class="wintitle">“企业功能板”</span>中管理用户和产品配置（群组）。企业仪表板是Adobe营销、创意和Document Cloud的管理界面。 </p> <p>您将能够： </p> 
    <ul id="ul_BD8F095B2A2D48379928C1E4D6B86F63"> 
     <li id="li_922FB8DE1BC34567AA5316C230E27779">为产品、工具、产品、报表包等创建产品配置。 </li> 
     ...
     <li id="li_E8FD5A1C454F4AE4BE00B3CD9EB7BE4F">将权限应用于特定维度和指标。 </li> 
    </ul> <p>此外，当前的管理工具用户管理功能将收到重要增强。 </p> <p> <p class="important">注意：有关更多信息，请参阅 <a href="https://marketing.adobe.com/resources/help/en_US/reference/permissions-changes.html" format="html" scope="external">2016 年秋季管理产品变更</a>。 </p> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>所有报告套件访问 </p> </td> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <b>Developer Connection 内容更新</b>（已于 2016 年 7 月 25 日添加） </p> <p><a href="https://marketing.adobe.com/developer/documentation/classifications-1-4-saint/r-createexport" format="https" scope="external">Classifications.CreateExport</a> 的更新： </p> 
    ...
    </ul> <p> <b>弃用说明</b> </p> <p> Web服务API版本1.2已于2014年2月20日正式弃用。 将于2016年9月15日终止。 届时，Adobe将删除API服务器响应版本1.2 API请求的能力。 对 <span class="filepath">https://api.omniture.com/admin/1.2</span> 端点发出的任何 API 请求都将返回 404 错误。 
     </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_79999DF08A424BFDA59BDBCD2E738A4C"> 
      ...
      <li id="li_562AFA713CA34C009DC2FB0B4B8A26EF">管理员：修复了阻止使用Adobe ID通过活动登录的用户跟踪Marketing Cloud的问题。 此修复程序为通常通过活动名、用户名和密码登录的用户复制公司跟踪。 (AN-124792) </li> 
      <li id="li_0BDA039583054473BC3190E0AF57D03D">修复了阻止将共享计算量度应用于非管理员用户的问题。 (AN-125412) </li> 
      <li id="li_A5B1C8700C56426AACECBFF448DB06B3">修复了导致发送报告的罕见问题，即使报告未计划分发也是如此。 (AN-126552) </li> 
      <li id="li_D1237FEB03554D7793CCF09148F32530">修复了默认产品登录名为SearchCenter的用户出现的登录问题(AN-126281)。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_6F297BE1227F4A09B3B6E69330CE648E"> 
      ...
      <li id="li_C6B5C8D3ED38475889EDBBB7DFC0E4F3">修复了每周项目计划中导致一周中的某天无法在界面中正确显示的问题。 (AN-125760) </li> 
      ...
      <li id="li_7B10BCEA62D1427BB5A7574A88B756FD">修复了使用多个指标和区段的项目的表中的排序问题。 (AN-126162) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BB48AEAB77574B79A823FBA770449105"> 
      ...
      <li id="li_11C668A5F12F46C0969C279F33F3AC6D">从访客中删除了不支持的叠加度量(新Activity Map和新客户)。 (AN-124056) </li> 
      <li id="li_44571DB551274B25A37C13F0D0A8505A"> Activity Map实时模式现在报告网页中存在的所有链接。 (AN-116094) </li> 
      <li id="li_7044F2E995024A48873E6209146C1678">修复了在重新加载页面后导致计算度量不显示的问题。 (AN-125900) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_21AA1745F6154EFAA67D00D9531417D3"> 
      <li id="li_77E57F08C316489D959009967CB160C9"> 在Data warehouse中为页面视图添加区段支持(AN-125067)。 </li> 
      <li id="li_59787469534B455686696BA9E095D388"> 修复了分类查找表中存在“0”哈希值的规则中的段逻辑问题(AN-125340)。 </li> 
      <li id="li_047E532F694B4999BC3EF156FA8029AC">添加了发送空报告而不是响应“无数据”的功能。 (AN-126210) </li> 
      <li id="li_4D264642BB344468A8A6E2D6EB3B7C82">在界面的虚拟报告包更改后创建的新电子邮件分发列表现在将在Data warehouse中工作。 (AN-123842) </li> 
      <li id="li_74CFDE5092ED471594A4EE8893D2ADEA">现在，细分在它生成的电子邮件中提供正确的MIME类型(AN-124243) </li> 
      <li id="li_93364B7D632E49C5AE6C222BCBE5EC1F">修复了阻止显示参与度量名称的问题。 (AN-117260) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<!-- <draft-comment> 
     ...
     <ul id="ul_3AAA9C4D782142DEBC1575283AE90CC5"> 
      ...
      <li id="li_C64B1DCB5679439A8FD77CF03A4D5F3B">修复了导致AppMeasurement调用访客API中错误的模糊化方法的问题。 (AN-126006) </li> 
      <li id="li_B9E05F749D93432C8D5D7A7D1BA0A070">修复了导致JavaScript错误的问题："属性仅在v:image上有效"。 (AN-124009) </li> 
     </ul> </p> 
<!-- <draft-comment> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>“<span class="wintitle">示例错误报表</span>”检查入站数据源文件中记录处理的成功和失败率。错误报告以交互式条形图显示数据并以表格形式提供摘要度量。 此外，它还包含一个选项，该选项以固定时间间隔对文件进行采样并显示每种错误类型最常见的错误。 </p> <p>该功能在7月底发布后，将提供相关文档。 </p> </td> 
  </tr> 
  <tr> 
...
* 将Google Bid Manager从v201601升级到v201603。 (AAM-24618)
* 修复了用户档案合并规则报告显示0的错误。 (AAM-24685)
* 修复了由于审核表中出现唯一键错误，客户无法编辑或删除用户组的错误。 (AAM-24864)
* 修复了对S2S和批量S2S目标没有强制限制的错误。 (AAM-24905)
* 更改了旧版登录名和Marketing Cloud之间的分隔线的样式。 (AAM-24378)
* 修复了删除用户、组或数据源后显示错误消息的错误。 (AAM-24638)
  ...
  <tr> 
   ...
   <td colname="col2"> <p>新增功能包括： 
     <ul id="ul_85C33A54E1B24FFDA1B948D5B337C2CA"> 
      <li id="li_128ED169444F4F11B221CBB19AD0B918"><p>正则表达式（正则表达式）支持过滤器和缓存规则。 </p></li> 
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>AEM包括经典和触屏优化UI。 因此，“客户的用户界面Recommendations”主题可以帮助您确定最适合您使用的UI。 在项目实施期间或从早期版本更新时，此信息会派上用场。 </p> </td> 
  </tr> 
  <tr> 
