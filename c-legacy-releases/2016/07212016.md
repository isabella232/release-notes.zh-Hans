---
description: 发行说明2016年7月
keywords: 发行说明
seo-description: 发行说明2016年7月
...
<table id="table_519893D8565A4D489CB13D5EAF1E9325"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>“管理应用程序设置”的新权限要求 </p> </td> 
...
| 功能 | 描述 |
|---|---|
| Marketing CloudID服务工具 | 现在，默认情况下启用了在页面顶部加载DTM时使用Marketing CloudID服务工具的选项。 |
...
此版本将版本增加到1.6.0。它包含以下功能、错误修复和其他更改。
...
<table id="table_0CF2AF14F0E64FA7A48C340C3D94E98F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>AppMeasurement代码要求 </p> </td> 
...
<table id="table_BEDD720754F84255A64598018911E336"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>CORS 允许浏览器从当前域以外的域请求资源。<span class="keyword">Marketing Cloud</span> ID 服务支持 CORS 标准以启用客户端跨域资源请求。ID 服务会在不支持 CORS 的浏览器上还原为 JSONP 请求。(AAM-23988) </p> <p>请参阅： </p> 
    <ul id="ul_36247A565B5842B3A5F0553440327BC8"> 
     <li id="li_1DBEEFBA4C4B452BAADCE86B102DD337"> <a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-cors.html.html" format="https" scope="external"> Marketing Cloud ID 服务中的 CORS 支持 </a> </li> 
...
* 已将 ` loadTimeout` 的默认值从 500 毫秒更改为 30,000 毫秒（30 秒）。请参阅 [ID 服务 getInstance 函数使用的变量](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid_getinstance.html)。(MCID-96)
* 向 ` d_fieldgroup` 的 ID 同步调用添加了 ` dpm.demdex.net` 参数。此新参数用于进行内部故障诊断和调试。(MCID-94)
* 向 ID 服务 iFrame 添加了标题属性。iFrame 标题有助于屏幕阅读器向与在线内容交互时需要帮助的用户提供页面信息。iFrame title 属性设置为 ` Adobe ID Syncing iFrame`。(MCID-81)
* 添加了 ` idSyncAttachIframeASAP: true` 作为可选标记，您可以在 ` Visitor.getInstance` 函数中设置此标记。设置为 ` true` 时，ID 服务会尽可能快地加载 ID 同步 iFrame。这旨在帮助提高 ID 同步匹配率。默认情况下，ID 服务会在加载窗口时加载 iFrame。(MCID-86)

**新文档和修订的文档**

* 新：[为 Analytics 和 Audience Manager 实施 Marketing Cloud ID 服务](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-setup-aam-analytics.html)
* 已修订：[测试和验证 Marketing Cloud ID 服务](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-test-analytics.html)

另请参阅 [Marketing Cloud ID 服务](https://docs.adobe.com/content/help/en/id-service/using/home.html)产品文档。
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>2016 年 10 月，Analytics 管理员将可以在<span class="wintitle">“企业功能板”</span>中管理用户和产品配置（群组）。企业仪表板是Adobe营销、创意和Document Cloud的管理界面。 </p> <p>您将能够： </p> 
    <ul id="ul_BD8F095B2A2D48379928C1E4D6B86F63"> 
     <li id="li_922FB8DE1BC34567AA5316C230E27779">为产品、工具、产品、报表包（等）创建产品配置。 </li> 
     <li id="li_598E3DA610694E13B3B0C2294E8B8096">创建用户并将其分配给产品配置。 </li> 
     <li id="li_CECBE177CFC4491CB460FA0A93C93B31">将特定产品配置的管理角色委派给用户。 </li> 
     <li id="li_E8FD5A1C454F4AE4BE00B3CD9EB7BE4F">将权限应用于特定维度和量度。 </li> 
    </ul> <p>此外，当前管理工具用户管理功能将收到重要增强。 </p> <p> <p class="important">注意：有关更多信息，请参阅 <a href="https://marketing.adobe.com/resources/help/en_US/reference/permissions-changes.html" format="html" scope="external">2016 年秋季管理产品变更</a>。 </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>AppMeasurement 1.6.3和访客 API 1.6.0 </p> </td> 
 ...
 <p>Adobe 已为 <span class="term">AppMeasurement for Flash</span> 库发布了<a href="https://helpx.adobe.com/cn/security/products/analytics/apsb16-13.html" format="https" scope="external">安全更新 APSB16-13</a>。此更新消除了该库的重要漏洞（仅当启用了 <span class="codeph">debugTracking</span> 时才会出现），别有用心的人可能会利用该漏洞发起<a href="https://www.owasp.org/index.php/DOM_Based_XSS" format="https" scope="external">基于 DOM 的 XSS 攻击</a>。 </p> <p> <p class="important">注意：仅当 <span class="codeph">debugTracking</span> 处于启用状态时，此问题才会影响 <span class="term">AppMeasurement for Flash</span>（默认配置中 <span class="codeph">debugTracking</span> 处于禁用状态）。<b>如果受此问题影响，我们强烈建议您立即禁用 <span class="codeph">debugTracking</span>。</b>下面是一些示例代码： </p> </p> 
  ...
  <tr> 
   <td colname="col1"> SiteCatalyst 14、ExcelClient等 2016年9月 </td> 
   <td colname="col02"> <p>2016 年 3 月 17 日 </p> </td> 
   <td colname="col2"> <p>SiteCatalyst 14、ExcelClient和许多其他旧版组件将于2016年9月停用。 </p> <p>这意味着所有的 SiteCatalyst 14 用户界面和若干相关功能都将无法访问。为了充分做好准备，请查看<a href="https://marketing.adobe.com/resources/help/en_US/sc/user/upgr_home.html" format="https" scope="external">此列表</a>，了解受影响的组件、所需的用户操作以及有关如何使用其他替代服务的建议。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Web Services v 1.2 API生命周期结束 </p> </td> 
   <td colname="col02"> <p>2016 年 2 月 18 日 </p> </td> 
   <td colname="col2"> <p>Web服务API的版本1.2于2014年2月20日正式弃用。 将于2016年9月15日终止。 届时，Adobe将删除API服务器响应版本1.2 API请求的功能。 对 <span class="filepath">https://api.omniture.com/admin/1.2</span> 端点发出的任何 API 请求都将返回 404 错误。客户可在此寿命结束日期之前从 1.2 版 API 升级到 1.4 版 API，以防止他们的 API 应用程序出现服务中断。 
     <!--https://jira.corp.adobe.com/browse/AN-118670--></p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>英国邮政编码 </p> </td> 
   <td colname="col02"> <p>2016 年 2 月 18 日 </p> </td> 
   <td colname="col2"> <p>Adobe的地理服务提供商正在改变我们接收英国邮政编码的方式。 3月18日或前后，我们将从提供截断的英国邮政编码向提供完整的邮政编码转变。 </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在<span class="uicontrol">项目</span> &gt; <span class="uicontrol">项目信息</span>中添加了一个信息模式。此面板会显示以下项目信息：
     ...
     <ul id="ul_AC21E32F5F6E4B2480455AE681F56BAB"> 
      ...
      <li id="li_E7E6A02B373A487699BE1CEA4E938F3F">上次修改时间 </li> 
      <li id="li_212CE5A04D84449281CD8D78CD49F981">标记 </li> 
      <li id="li_40EECF14652A4787ABFD2E456BEB54AF">描述 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>（2016年6月新增）为新客户简化实施 </p> </td> 
   <td colname="col2"> <p>通过 <span class="keyword">Marketing Cloud</span> 登录 <span class="keyword">Analytics</span> 的新客户可以使用 <span class="term">Adobe Analytics 快速入门</span>模式快速实施<span class="keyword"> Analytics </span>，然后使用动态标签管理部署 Analytics。 </p> <p>此简化的实施由动态标签管理托管，使您能够： </p> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <b>Developer Connection 内容更新</b>（已于 2016 年 7 月 25 日添加） </p> <p><a href="https://marketing.adobe.com/developer/documentation/classifications-1-4-saint/r-createexport" format="https" scope="external">Classifications.CreateExport</a> 的更新： </p> 
    ...
    </ul> <p> <b>弃用说明</b> </p> <p> Web服务API的版本1.2于2014年2月20日正式弃用。 将于2016年9月15日终止。 届时，Adobe将删除API服务器响应版本1.2 API请求的功能。 对 <span class="filepath">https://api.omniture.com/admin/1.2</span> 端点发出的任何 API 请求都将返回 404 错误。 
     </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_79999DF08A424BFDA59BDBCD2E738A4C"> 
      ...
      <li id="li_562AFA713CA34C009DC2FB0B4B8A26EF">管理员：修复了阻止使用活动的Adobe ID通过Marketing Cloud登录的用户跟踪的问题。 此修复程序将复制活动跟踪，以传统方式通过公司名、用户名和密码登录的用户。 (AN-124792) </li> 
      <li id="li_0BDA039583054473BC3190E0AF57D03D">修复了阻止共享计算量度应用于非管理员用户的问题。 (AN-125412) </li> 
      <li id="li_A5B1C8700C56426AACECBFF448DB06B3">修复了导致发送报表的罕见问题，即使未计划分发报表。 (AN-126552) </li> 
      <li id="li_D1237FEB03554D7793CCF09148F32530">修复了默认产品登录名为SearchCenter(AN-126281)的用户出现的登录问题。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_6F297BE1227F4A09B3B6E69330CE648E"> 
      <li id="li_602B55D4F7DF4D0C8B240C0B43679808"> 计划项目现在使用报表包时区，而不是浏览器的时区。 (AN-126233) </li> 
      <li id="li_56A2CDE08D274BE897DB1DC7EDAE61B1">添加了在<span class="wintitle">计划项目</span>中指定项目的 PDF 宽度的功能。(AN-124242) </li> 
      <li id="li_413B05B2DE7B4910B80A334A4AD8D26A"> 修复了在Chrome浏览器中预览PDF项目时下载PDF项目时发生的错误。 (AN-123674) </li> 
      <li id="li_4584537608434E7CBCBCC18EA8F01B59">修复了阻止放置组件和调整组件大小的问题（在少数情况下）。 (AN-126175) </li> 
      <li id="li_976D720D2919457A91C2F4CC5DCBB54F">修复了在添加浏览器区段后在表中更改浏览器类型时出现的区段定义问题。 (AN-126086) </li> 
      <li id="li_C6B5C8D3ED38475889EDBBB7DFC0E4F3">修复了每周项目计划中存在的一个问题，该问题导致该周的某天无法在界面中正确显示。 (AN-125760) </li> 
      ...
      <li id="li_D8E69F309E144BCB999B19B59AE502A4">修复了在登录后无法显示项目仪表板的随机问题。 (AN-124635) </li> 
      <li id="li_7B10BCEA62D1427BB5A7574A88B756FD">修复了表格中使用多个量度和区段的项目的排序问题。 (AN-126162) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BB48AEAB77574B79A823FBA770449105"> 
      ...
      <li id="li_11C668A5F12F46C0969C279F33F3AC6D">从Activity Map中删除了不受支持的叠加量度(新访客和新客户)。 (AN-124056) </li> 
      <li id="li_44571DB551274B25A37C13F0D0A8505A"> Activity Map实时模式现在报告网页中存在的所有链接。 (AN-116094) </li> 
      <li id="li_7044F2E995024A48873E6209146C1678">修复了在重新加载页面后导致计算量度不显示的问题。 (AN-125900) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Report Builder </td> 
   <td colname="col2"> <p> 改进了对计划工作簿的支持，这些工作簿最初从Excel Web界面通过Office 365打开。 (AN-118240 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Data Warehouse </td> 
   <td colname="col2"> <p> 
     <ul id="ul_21AA1745F6154EFAA67D00D9531417D3"> 
      <li id="li_77E57F08C316489D959009967CB160C9"> 在Data warehouse(AN-125067)中为页面视图添加细分支持。 </li> 
      <li id="li_59787469534B455686696BA9E095D388"> 修复了分类查找表中存在“0”哈希值的规则中的区段逻辑问题(AN-125340)。 </li> 
      <li id="li_047E532F694B4999BC3EF156FA8029AC">添加了发送空报告而不是响应“无数据”的功能。 (AN-126210) </li> 
      <li id="li_4D264642BB344468A8A6E2D6EB3B7C82">在界面的虚拟报表包更改后创建的新电子邮件分发列表现在将在Data warehouse中工作。 (AN-123842) </li> 
      <li id="li_74CFDE5092ED471594A4EE8893D2ADEA">划分现在在它生成的电子邮件中提供适当的MIME类型(AN-124243) </li> 
      <li id="li_93364B7D632E49C5AE6C222BCBE5EC1F">修复了阻止显示参与量度名称的问题。 (AN-117260) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<!-- <draft-comment> 
     ...
     <ul id="ul_3AAA9C4D782142DEBC1575283AE90CC5"> 
      ...
      <li id="li_C64B1DCB5679439A8FD77CF03A4D5F3B">修复了导致AppMeasurement在访客 API中调用错误的模糊化方法的问题。 (AN-126006) </li> 
      <li id="li_B9E05F749D93432C8D5D7A7D1BA0A070">修复了导致JavaScript错误的问题："属性仅对v:image有效"。 (AN-124009) </li> 
     </ul> </p> 
<!-- <draft-comment> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>示例错误报告 </p> </td> 
   <td colname="col2"> <p>“<span class="wintitle">示例错误报表</span>”检查入站数据源文件中记录处理的成功和失败率。“错误报告”在交互式条形图中显示数据，并以表格形式提供摘要量度。 此外，它还包含一个选项，该选项以固定时间间隔对文件进行采样并显示每种错误类型最常见的错误。 </p> <p>当该功能在7月底发布时，将提供相关文档。 </p> </td> 
  </tr> 
  <tr> 
...
* 已将Google Bid Manager从v201601升级到v201603。 (AAM-24618)
* 修复了用户档案合并规则报告显示0的错误。 (AAM-24685)
* 修复了由于审核表中存在唯一键错误，客户无法编辑或删除用户组的错误。 (AAM-24864)
* 修复了对S2S和批量S2S目标没有强制执行限制的错误。 (AAM-24905)
* 更改了分隔旧版登录名和Marketing Cloud的行的样式。 (AAM-24378)
* 修复了删除用户、用户组或数据源后显示错误消息的错误。 (AAM-24638)
...
* [开始批量管理](https://marketing.adobe.com/resources/help/en_US/aam/c_bulk_start.html)。包括一张新的批量管理工作表。
* [使用平台级别关键值进行地理定位](https://marketing.adobe.com/resources/help/en_US/aam/c_tb_platform_vars.html)。包括一个包含最新值的已更新关键值列表。

**修复、增强功能和弃用功能**

* 修复了回复推文时出现错误，指出推文超过140个字符的问题。
* 修复了启用某些链接缩短工具的切换按钮无法正常工作的问题。
* 修复了审核方回复未在审核中显示的问题。
...
<table id="table_99BD3F007D164A2AA415E78C633D7927"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>AEM上的Gems是由Adobe专家交付的一系列技术深度潜水。 该系列是对产品文档和技术渠道的补充。 它还帮助开发人员联系并详细探索特定主题。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_04819C0464594ECFB211C253C34E69CA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>新增功能包括： 
     <ul id="ul_85C33A54E1B24FFDA1B948D5B337C2CA"> 
      <li id="li_128ED169444F4F11B221CBB19AD0B918"><p>常规表达式（正则表达式）支持过滤器和缓存规则。 </p></li> 
      <li id="li_2E996C54B8E24C01AC3C40F2E68308EA">支持所有平台上的HTTP永久连接（也称为HTTP保持活动）。 </li> 
...
下表包含一系列推荐主题的链接。这些主题可以帮助您充分利用AEM的实施和使用。
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>AEM包括经典和触屏优化UI。 因此，“客户用户界面Recommendations”主题可以帮助您确定最适合您使用的UI。 在项目实施期间或从早期版本进行更新时，此信息会派上用场。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 有关何时创建索引以及何时不需要它们的信息。 还包括避免在不需要时使用查询的提示，以及优化索引和查询性能的提示。 </p> </td> 
  </tr> 
  <tr> 
...
Advertising Cloud帮助在产品中可用：**[!UICONTROL ?  > 帮助目录]**。
...
<table id="table_D245BAB62A304D5B9018375ABFEFFC09"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 关于将于2016年秋季发布的权限更改的重要声明。 </p> </td> 
   <td colname="col3"> <p>2016 年 7 月 21 日 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <a href="https://docs.adobe.com/content/docs/cn/aem/6-2.html" format="https" scope="external"> Adobe Experience Manager 6.2 </a> </td> 
   <td colname="col2"> <p>Adobe Experience Manager 6.2是对Adobe Experience Manager 6.1代码库的升级版。它提供新增和增强功能、关键客户修复、高优先级客户增强和面向产品稳定化的常规错误修复。 它还包括Adobe Experience Manager 6.1功能包、热修复和Service Pack发行版。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 借助Analytics集成的Marketing Cloud受众，您可以将Marketing Cloud受众数据(如人口统计信息（如性别或收入水平）、心理信息（如兴趣和爱好）、CRM数据和广告印象数据)并入任何Analytics工作流程中。 </p> </td> 
   <td colname="col3"> <p>2016 年 4 月 14 日 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>添加了有关Analysis Workspace中新增功能的文档。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>更新的Analysis Workspace产品文档，包含功能说明、用于创建项目的任务、视频和使用案例。 </p> </td> 
   <td colname="col3"> <p>2015 年 9 月 17 日 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>添加了可选时间戳的产品文档和最佳实践。 此功能允许您在报表包中集成有时间戳和未有时间戳的数据。 默认情况下，所有新报表包均为可选时间戳。 </p> </td> 
   <td colname="col3"> <p>2015 年 9 月 17 日 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>请参阅Data Workbench 6.5发行说明，了解升级说明以及新增功能和错误修复的列表，包括新的“关联”表和弦图，以及对可视化、用户界面、算法和导出功能的更新。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>更新了分类规则生成器，以便您在编辑现有规则集时（在创建规则集后）将报表包和变量添加到规则集。 以前，您在创建规则集时指定了变量和报表包。 此更改可防止分类变量出现报告的问题。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>用户档案 Link可与跨设备数据源结合使用，以识别和收集经过身份验证的网站访客的特征。 它包含用户档案合并规则功能，使您能跨多个设备准确细分和目标用户。 </p> </td> 
   <td colname="col3"> <p>2015 年 8 月 20 日 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>计算量度现在允许使用分段量度、更高级的数学以及组织和共享量度的能力。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>构建数据表并将量度、维度、区段和多个可视化拖放到项目面板。 </p> </td> 
   <td colname="col3"> <p>2015 年 6 月 18 日 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>已将 <a href="https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/cookies-first-party.html" format="https" scope="external">Adobe 托管的证书计划</a>添加到修订的 <span class="term">第一方 Cookie</span> 产品文档。 </p> <p>托管证书项目允许您免费为第一方Cookie实施新的第一方SSL证书。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>改进了Adobe Mobile产品文档。 </p> </td> 
   <td colname="col3"> <p>2015年5月22日 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>实现核心服务解决方案实施现代化所需要的高级别全面工作。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>如果您在客户关系管理(CRM)数据库中捕获了企业客户数据，则可以将该数据上传到Marketing Cloud。 </p> </td> 
   <td colname="col3"> <p>2015 年 3 月 19 日 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在<span class="uicontrol">管理工具</span> &gt; <span class="uicontrol">分类规则生成器</span> &gt; <span class="term">&lt;规则集名称&gt;</span> 中，您可以通过两个新增选项来选择覆盖模式： </p> 
    ...
    </ul> <p>以前，如果某个键已在任何列或单元格中分类，则该规则不会在该键上运行，并且跳过了表中的行。 </p> </td> 
