...
<table id="table_4E4B34EEE3D94D78BA1A1FBC62950559"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 触发器将分析和活动结合在一起，使营销人员能够定义和监控关键的消费者行为，然后生成跨解决方案通信以便用于实时决策和个性化。 例如，您可以为以下对象创建触发器： </p> 
    <ul id="ul_0B0893E7C7404528A33DC3AF5B600E21"> 
     <li id="li_A6E0A6DCE5554A54BB9528E32E1BF81A">Re-marketing for cart andapons or cart andapons with products removed. </li> 
     <li id="li_7DA4D06F70964E34872265B77F9F6526">会话开始或会话结束事件。 </li> 
     <li id="li_AB9A28929C6444C9A7E555A48431DED6">网站上的任何操作或操作序列，如不完整的表单和应用程序。 </li> 
    </ul> <p>配置: </p> 
    <ul id="ul_3113B4C40D6E458CAB4C6ECA2A95A4BE"> 
     <li id="li_B98B6922063645E2BA78833D27425F08"> <a href="https://marketing.adobe.com/resources/help/zh_CN/mcloud/triggers.html" format="html" scope="external">在 </a>Marketing Cloud<span class="uicontrol"> &gt; </span>激活<span class="uicontrol"> &gt; </span>触发器<span class="uicontrol">中，通过 Analytics 数据创建触发器</span>。 </li> 
...
添加了 ` disableThirdPartyCalls` 作为可选布尔标记，您可以在 ` Visitor.getInstance` 函数中设置此标记。若 ` disableThirdPartyCalls= true`，则 ID 服务将不会对其他域进行调用。默认情况下，` disableThirdPartyCalls= false`请参阅 [disableThirdPartyCalls](https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-disablethirdpartycalls.html)。(MCID-51)
...
<table id="table_519893D8565A4D489CB13D5EAF1E9325"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Android:应用程序内消息传递 </p> </td> 
   <td colname="col2"> <p>添加了打开深层链接URI的新消息类型。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Android:跟踪深层链接 </p> </td> 
   <td colname="col2"> <p>添加了启用第三方延迟深层链接跟踪的功能。 </p> <p> 
  ...
  <tr> 
   <td colname="col1"> <p>iOS:应用程序内消息传递 </p> </td> 
   <td colname="col2"> <p>添加了打开深层链接URI的新消息类型。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>虚拟报告包的时区选择 </p> </td> 
   <td colname="col2"> <p>现在，您可以在创建虚拟报告包时选择时区。 </p> <p>如果您选择一个，则它将与虚拟报告套件一起保存。 如果不选择一个，则使用父报表包的时区。 </p> <p>编辑虚拟报告套件时，使用创建的时区会显示在下拉选择器中。 如果在添加时区支持之前创建了虚拟报告套件，则父报告套件的时区将显示在下拉选择器中。 </p> <p>此外，如果您创建的虚拟报告套件的时区与父报告套件的时区不同，然后复制该虚拟报告套件，则复制的虚拟报告套件将引用父报告套件的时区，除非您手动更新时区。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Analysis Workspace的权限更改(AN-125014) </p> </td> 
   <td colname="col2"> <p>对Analysis Workspace进行了以下权限更改。 </p> <p>以前，您需要以下权限才能在Analysis Workspace创建区段或指标： </p> 
    <ul id="ul_E31EDD5966BA4114B39C472399A8BAFE"> 
     <li id="li_AA9697F4267F4D33816785E170D31303">段创建 </li> 
     <li id="li_068CAB35E810448BAC0FB7E5F77348A5">计算度量创建 </li> 
     <li id="li_FF6AF50592B64BC0AB2619212E003BC0">在Analysis Workspace创建／策划项目 </li> 
    </ul> <p>在此版本中，您只需要以下权限： </p> 
    <ul id="ul_5A68F2F72D9C4EB59E62983E3104E6F7"> 
     <li id="li_D50D001620D24EBD9774608A019EAAB9">段创建 </li> 
     <li id="li_31858007308C4F199D7843DD1D7AA2D7">计算度量创建 </li> 
    </ul> <p>如果您希望限制非管理员用户在特选的Analysis Workspace项目中创建新的区段和指标，请使用权限设置限制相关组创建区段和指标的能力。 </p> <p>这些权限可通过以下方式访问：<span class="ignoretag"><span class="uicontrol">管理</span> &gt; <span class="uicontrol">用户管理</span> &gt; <span class="uicontrol">组</span> &gt; <span class="uicontrol">[单击组]</span> &gt; <span class="uicontrol">报表访问</span> &gt; <span class="uicontrol">高级报告</span></span>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Dimension生成器中的数据名称更改 </p> </td> 
   <td colname="col2"> <p>区段生成器中的“完整域名”维度已被重命名为“<span class="term">域名</span>”，以匹配权限名称。(AN-129355) </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>data warehouse更新 </p> </td> 
   <td colname="col2"> 
    <ul id="ul_4E34357C5DB94CA891D228031C039BAC"> 
     ...
     <li id="li_F9778FD17DDE4485BFC1F8BA5E03A3F8">新的<span class="wintitle">开始日期</span>字段设为报表包的时区。开始日期和完成日期表示往返时间。 (AN-126155) </li> 
     <li id="li_4ACEC4300F4A4F26AFB337CA8F8A28DF">虚拟报表包已启用时区覆盖。 </li> 
    </ul> </td> 
  </tr> 
  <tr> 
...
<table id="table_A51B298EEEB5482383505B8C5A79E1B9"> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
     <li id="li_294227DF6E1346F18F5FA38805A5C2C3">某些报表不再提供移动设备的报表细分。 作为一项解决方法，请运行<span class="wintitle">设备报表</span>并将相关的量度添加到报表中。( AN-126460) </li> 
     <li id="li_02DFDE01795C47C7B1736A5ECFD0D848">修复了涉及报表包日期范围以外日期的区段无法正常工作的细分问题。 (AN-123911) </li> 
     <li id="li_32D6981F7FB444248EA448DCC9B3031E">修复了在删除区段所有者时发生的区段编辑错误。 已删除的区段所有者现在在日 <span class="term"> 志中 </span> 显示为未知用户。 (AN-129554) </li> 
     <li id="li_2DB137A2C3D4442F8DF65F11758FBE0D">修复了仪表板问题，该问题导致无法下载包含附带非现有检查点的流失报告的仪表板。 (AN-123380) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
     <li id="li_BE8C3497AA9A4FCA855130A0C7157F12">修复了“<span class="term">立即发送文件</span>”功能无法正常使用的问题。(AN-128055 和 AN-128057) </li> 
     <li id="li_6B38119EF3714058B75ADE1B0CF436E5">修复了在删除用户时，管理员 <span class="term"> 可 </span> 多次单击“删除”，从而导致Analysis Workspace项目消失的问题。 (AN-127911) </li> 
     <li id="li_C1B31221503F4F03AAD25E61A1F9C8AE">修复了阻止特选和共享Analysis Workspace项目向不同用户显示相同数据的问题。 (AN-126558) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_9A4E12DD7F254411AA9452735D63CA80"> 
     ...
     <li id="li_1275EB4FC5D84D04832D9DF8DB5DEDA8">现在，字符串规则中包含文字反斜杠、制表符或换行符的段可以正确计算。 (AN-129552) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9A5FC169793F4266922D1352CF0428AE"> 
      <li id="li_D46A0F2C1481431BA3E8E076BA1C9FE0"> 修复了规则构建器中规则集无法激活的问题。 (AN-127762) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
 ...
 <p> <b>另请参阅：</b><a href="../../c-legacy-releases/2016/09152016.md#mcvid" format="dita" scope="local">Marketing Cloud ID 服务</a>（以前称为<span class="term">访客 ID 服务</span>） </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b>弃用说明</b> </p> <p> Web服务API版本1.2已于2014年2月20日正式弃用。 将于2016年9月15日终止。 届时，Adobe将删除API服务器响应版本1.2 API请求的能力。 对 <span class="filepath">https://api.omniture.com/admin/1.2</span> 端点发出的任何 API 请求都将返回 410 错误。 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>可寻址受众1.1增强 </p> </td> 
   <td colname="col2"> <p>此更新提高了细分级可寻址受众的准确性，并展示了当前细分级受众的触及范围，以便进行活动规划和审阅。 请参阅<a href="https://marketing.adobe.com/resources/help/en_US/aam/addressable-audiences.html" format="https" scope="external">可访问的受众</a>。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* 从入门状态报告的错误列表中删除了“OK_With_Unused_Signals”错误。 (AAM-25240)
* 在 [!UICONTROL Audience Lab] 中，我们现在提醒您在删除任何区段测试组之前先下载 CSV。(AAM-25581)
* API现在可返回更准确的细分可寻址受众号。 (AAM-25460)
* “目标”和“区段”页面现在显示实际数字，而不是“区段可寻址”受众的估计数字。 (AAM-25461)
...
* 现在，从 [!DNL  Adobe Social] 内部转推的帖子与在 Twitter 本地转推的帖子相同。有关详细信息，请 [参阅审核单个帖子](https://marketing.adobe.com/resources/help/en_US/social/t_mod_individual_tweet.html)[和发布引用的帖子](https://marketing.adobe.com/resources/help/en_US/social/t_post-quoted-retweet.html)。
* Social 标签将于 10 月 1 日后在 Adobe Analytics 中可用（准确日期待定）。
   * 在10月1日 [!DNL  Adobe Social] 之后，用户将能够使用 [社交标记](https://marketing.adobe.com/resources/help/en_US/social/c_settings_tag_manr.html) ，对出站内容进行分类并在中报告此内容 [!DNL  Adobe Analytics]。 要获取这项新增功能的访问权限列表，请联系您的 [!DNL  Adobe Social] 客户经理或 Social 技术支持。从此处，您将收到有关获取访问权限和启用协助的后续步骤的更新。
...
<table id="table_5AB641198DF34491AE6D411A9BA32B51"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p> <a href="https://docs.adobe.com/docs/en/aem/6-2/release-notes/communities.html#Feature%20Pack%201" format="https" scope="external">Communities 6.2 功能包 1</a> 和 <a href="https://docs.adobe.com/docs/en/aem/6-1/release-notes/communities.html#Feature%20Pack%205" format="https" scope="external">6.1 功能包 5</a> 发布于 2016 年 8 月 30 日。此版本包括以下内容： </p> 
    <ul id="ul_D560F15F3ED64CD69E3D32CC48AA2740"> 
     <li id="li_43180B2A97AF49DD820978776DFE95D1">Adobe Social资源提供商。 </li> 
     <li id="li_1F479A90D5354A01A209FF083D507DBB">社交组件框架增强。 </li> 
     <li id="li_64A4A029E43D4BDABFB8F677B6799749">批量审核。 </li> 
     <li id="li_D0BAD5C6DCDF47EDB285050E0ADFDE2C">统包社区站点。 </li> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>AEM 6.1 Service Pack 2包括： </p> 
    <ul id="ul_83264665F5074087B793358B37CBDFB8"> 
     <li id="li_FBCCCBAF5F0D4478A9432ED1DDB2B48D">内置存储库(Apache Jackrabbit Oak)现已更新至版本1.2.16。 </li> 
     <li id="li_0FBFB1A818D745489F0E5FF6F3BB44D3"> 在Oak版本1.2.7(包含在AEM 6.1 SP1中)和1.2.16（包含在SP2中）之间进行了改进。 </li> 
     <li id="li_D414073C0B3E473E9B3352649C2B48C2">消除资产的流程编辑预设中的差异和错误。 </li> 
     <li id="li_D8B8C9D43F804D44875D6D343AD630CE"> 提高了创作模式的响应度并改进了站点中的功能组件，如传送组件。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>AEM社区文章 </p> </td> 
   <td colname="col3"> <p>现在提供了一篇详细介绍构建电子商务提供商的所有步骤的新文章。 </p> <p>请参阅<a href="https://helpx.adobe.com/experience-manager/using/ecommerce62.html" format="https" scope="external">创建自定义 Adobe Experience Manager 6.2 电子商务提供程序</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>即将召开的本地用户组会议 </p> </td> 
   <td colname="col3"> <p>加入您所在地区的同行，或者如果您正在旅行，则加入用户组会议。 Adobe Systems 在<a href="https://communities.adobe.com/en/communities/aem_technologistsdevelopersarchitects/events.html" format="https" scope="external">此处</a>的社区日历中列出了每一个活动。 </p> <p>西雅图用户组具有两个即将召开的会议。请在 <a href="https://www.meetup.com/Seattle-Adobe-CQ-AEM-Meetup-Group/" format="https" scope="external">https://www.meetup.com/Seattle-Adobe-CQ-AEM-Meetup-Group/</a> 参阅详细信息。 </p> <p><a href="https://www.meetup.com/Melbourne-AEM-CQ-Meetup/" format="http" scope="external">墨尔本 Adobe Experience Manager 碰头</a>组将举行一次代码竞赛。注册您的团队以出席 Adobe Marketing Cloud – 社区展 (AMCCE) 的截止日期为 2016 年 9 月 30 日。 您可以在以下地址注册：<a href="https://www.surveymonkey.com/r/R596336" format="https" scope="external">https://www.surveymonkey.com/r/R596336</a>。 </p> <p>AEM 用户组在荷兰阿姆斯特丹的下一次会议将于 2016 年 11 月 3 日召开。您可以在<a href="https://www.meetup.com/AEM-Developer-Meetup/events/233761022/?rv=ea1&amp;_af=event&amp;_af_eid=233761022&amp;https=off" format="http" scope="external">此处</a>进行回复。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>咨询AEM社区专家网络研讨会 </p> </td> 
   <td colname="col3"> <p>录制的8月网络研讨会标题为“AEM和电子商务”，可在以下位置观看： </p> 
  ...
  <tr> 
   <td colname="col2"> <p>AEM GEM网络研讨会 </p> </td> 
   <td colname="col3"> <p>上次录制的名为“设置和配置AEM Dynamic Media”的GEM网络研讨会可在以下位置观看： </p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>AEM开发人员社区事件由Pro!Vision主办，9月26-28日在柏林。 </p> <p>可在此处购票：<a href="https://adapt.to/2016/en.html"> https://adapt.to/2016/en.html </a>。 </p> </td> 
  </tr> 
  <tr> 
