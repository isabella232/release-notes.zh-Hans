...
修订了用于 [!DNL  Analytics] 客户的 ID 服务实施过程。请参见[使用 Analytics 设置 Marketing Cloud ID 服务](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-setup-analytics.html)。
