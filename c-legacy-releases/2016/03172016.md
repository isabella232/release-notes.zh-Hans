...
修订了用于 [!DNL  Analytics] 客户的 ID 服务实施过程。请参阅[使用 Analytics 设置 Marketing Cloud ID 服务](https://marketing.adobe.com/resources/help/zh_CN/mcvid/?f=mcvid-setup-analytics.html)。
