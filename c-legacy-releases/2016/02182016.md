...
如果您通过 **[!UICONTROL ]Marketing Cloud &gt; 激活**界面访问动态标签管理，但您的动态标签管理帐户没有链接至 Marketing Cloud (Adobe ID)，则您将无法登录到动态标签管理。要避免出现此问题，请在新的浏览器选项卡中直接导航至 [https://dtm.adobe.com](https://dtm.adobe.com)。
