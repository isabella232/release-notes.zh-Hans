...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>如何向 <span class="wintitle"> Audience Manager </span>提交GDPR请求以及有关[！DNL Audience Manager满足GDPR要求。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 如何使客户能够删除 <span class="wintitle"> 其Target </span> 访问者配置文件中的数据。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>临时分析项目转换器通过单击按钮将您的临时项目转换为 <span class="uicontrol"> Analysis Workspace </span>。 </p> <p>然后，可根据需要在 [!UICONTROL Analysis Workspace] 中使用、修改和计划复制的项目。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>计划于 2018 年 5 月 15 日发行生效</b> </p> <p> <span class="term">mc_ udiences</span> 列被添加进来。<span class="term"> mc_受众 </span> 是Adobe <span class="wintitle"> Audience Manager的Audience Analytics细分ID列表 </span>。 </p> <p>注意：这并不包括友好名称，因为它们是 ID 的一个分类。 </p> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>我们接近欧洲一般数据保护规定(GDPR)的2018年月25日开始法律，我们已准备文档以协助您管理Audience Manager中 <span class="wintitle"> 的消费者数据 </span> 以履行GDPR义务。请参阅： </p> <p> 
...
## [!DNL Advertising Cloud] (以前称为Advertising Cloud)
