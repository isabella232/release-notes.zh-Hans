...
<table id="table_5405964A0900476282E85E3BF9116C8B"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p><b>重要说明：2018 </b>年5月25日GDPR生效后，Adobe将对Data Connector(以 <b>前是Genesis)合作伙伴管理的FTP帐户中剩余的文件实施自动删除。</b>（这并非适用于所有属于 Analytics 客户的 FTP 帐户。）目前，FTP 文件夹中的数据将无限期保留，这可能会使公司面临无法为遵守 GDPR 做好准备的风险。从 2018 年 5 月 25 日开始，Adobe 将删除数据连接器合作伙伴托管的 FTP 服务器上到达服务器的时间达到 30 天的所有文件。
   </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_40C583EE96F146DAB1978EF7A1F15116"> 
     <li id="li_773940B3D52F4442B37CC7A7D731B797"><b>每日提示</b>：定期生成提示，并将其显示在界面的右下角（包含一个短视频）。They are meant to familiarize you with <span class="uicontrol">Analysis Workspace</span> features. 您可以通过单击提示旁边的 X 或者单击<span class="uicontrol">帮助</span> &gt; <span class="uicontrol">禁用每日提示</span>来停用提示。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_A50A05631E574C83AD7075579B14ACF1"> 
      <li id="li_227327CC9233438688BF7F593027C1DE">Fixed an issue that occurred when opening the Calculated Metric Builder from <span class="uicontrol">Analysis Workspace</span>. 该问题曾导致函数下拉列表不显示任何选项。(AN-160698) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_666BB742E5BE4CC9BE95E697DA5DBB67"> 
      ...
      <li id="li_DB39E7BF56304FAB8B8C452CEDCF589B">修复了与 Analytics for Target 分类有关的一个问题：以后，当您通过从其他已设置 Target 分类的报表包复制其设置来创建报表包时，Target 分类将映射到新的报表包。(AN-156702) </li> 
