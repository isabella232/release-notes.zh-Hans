...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>新增了 [!UICONTROL Mobile]“消息”模板和“位置”模板 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>如果贵公司的贡献分析令牌数量有限，则您每次用掉一个令牌后 [!UICONTROL Analysis Workspace] UI 中会显示相关通知。这可以让您知晓还剩下多少令牌。 </p> <p>（管理员用户：您可以通过编辑群组权限对能够使用令牌的人员进行限制。） </p> <p> <a href="https://marketing.adobe.com/resources/help/en_US/analytics/contribution/ca_main.html" format="html" scope="external"> 更多... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>对 [!UICONTROL Analysis Workspace] 中“无”/“未指定”的工作方式进行了更改，从而使其与 [!UICONTROL Reports &amp; Analytics]、区段生成器和 [!UICONTROL Analysis Workspace] 中的维度值菜单保持一致。 </p> <p>这意味着在 [!UICONTROL Analysis Workspace] 的大多数项目中，值将显示为“未指定”而非“无”。(AN-146879) </p> </td> 
  </tr> 
  <tr> 
...
* 我们对派生信号的可用数量添加了 50,000 的限制。有关更多信息，请参阅[使用限制](https://marketing.adobe.com/resources/help/en_US/aam/usage-limits.html)。
...
<table id="table_885F194180FE42EFA04220C9299969E4"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 现在，可以直接从 [!DNL Adobe Campaign] Standard API 触发您工作流程的信号活动。 </p> <p>有关更多信息，请参阅<a href="https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#triggering-a-signal-activity" format="html" scope="external">详细的文档</a>。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
有关最新信息，请参阅 [Livefyre 发行说明](https://marketing.adobe.com/resources/help/en_US/livefyre/)。更新时间：2018 年 1 月 22 日，适用于 1 月 20 日版
