...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Analytics使用日志现在跟踪某人在 <span class="uicontrol"> Analysis Workspace中打开项目时的情况 </span> (除了现有的创建、更新、取消共享和删除操作跟踪)。这样可以更好地体现使用工作区的用户以及使用频率。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>2018 年 6 月，Adobe 停止支持 TLS 1.0 协议。Adobe <span class="wintitle"> Audience Manager </span> 功能不适用于使用仅支持TLS1.0的浏览器的最终用户。我们为您收集了一个浏览器、版本和TLS支持列表。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>现在，您可以通过共享的 Analytics 区段，创建 Google AdWords 再营销列表 (RLSA)。在此之前，广告商还必须拥有Adobe <span class="wintitle"> Audience Manager </span>。要符合条件，广告公司必须实施 Adobe Experience Cloud ID 服务，提供其 IMS 组织 ID，并在其网站上部署标签。 </p> </td> 
  </tr> 
  <tr> 
