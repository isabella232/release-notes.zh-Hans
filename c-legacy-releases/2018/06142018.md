  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_666BB742E5BE4CC9BE95E697DA5DBB67"> 
      ...
      <li id="li_88ABBF7D4F424A8A9FD284E87A8E1886">修复了在切换报表包时导致“目标分析”分类显示“未知”值的问题。(AN-156702) </li> 
      ...
      <li id="li_EFC5176579F244828E3680B9F9BDA71B">修复了 Analytics 区段未正确发布到 Audience Manager 的问题。(AN-162536) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>（后端）查找机制的变动将会从多方面影响报表。请注意，以下变动已大约在 <b>2018 年 2 月底</b>生效： </p> 
    <ul id="ul_7515E2E79FD94B8F8DFF4C2DBB9E6A84"> 
     ...
     <li id="li_E46207F194134AEA86F5CB2C8F26C76C">（<b>更新日期：2018 年 4 月 11 日</b><span class="uicontrol">）Reports &amp; Analytics 中不再提供汇总数据和当前数据的类别报表。</span>Web Service API 中的类别汇总报表将在 2018 年 5 月 10 日的 Adobe Analytics 维护版本中弃用。 </li> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>现在，您可以通过共享的 Analytics 区段，创建 Google AdWords 再营销列表 (RLSA)。Previously, the advertiser also had to have Adobe  <span class="wintitle"> Audience Manager </span>. 要符合条件，广告公司必须实施 Adobe Experience Cloud ID 服务，提供其 IMS 组织 ID，并在其网站上部署标签。 </p> </td> 
  </tr> 
  <tr> 
