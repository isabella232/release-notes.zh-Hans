...
需要帮助？请访问 [Adobe Experience League](https://experienceleague.adobe.com/?lang=zh-Hans/#home)，查找产品和技术文档、Adobe 策划课程、视频教程、快速解答、社区洞察以及由讲师指导的培训。相关内容已从 `docs.adobe.com` 移至此处。请更新相应的书签。
...
有关 Platform Launch 的更多信息，请参阅 [Experience Platform Launch 发行说明](https://experienceleague.adobe.com/docs/launch/using/release-notes/current.html?lang=zh-Hans)。
...
| 2020 年 12 月 9 日 | [在 Offer Decisioning 中制定规则](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/create-rules.html?lang=zh-Hans) | 视频 | 了解如何在 [!UICONTROL Offer Decisioning] 中制定规则。规则是使用 Platform [!UICONTROL 实时客户资料]中的事件和属性构建的，并对优惠资格进行限制。 |
...
| 2020 年 10 月 26 日（更新日期） | [使用 Salesforce CRM 源连接器摄取数据](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/ingest-data-from-salesforce-crm.html?lang=zh-Hans) | 视频 | 通过 Salesforce CRM 源连接器，您可以采用一种无缝且可扩展的方式，轻松地将数据从 Salesforce CRM 批量摄取到 Adobe Experience Platform 的实时客户资料和 Experience 数据湖中。 |
| 2020 年 10 月 13 日（更新日期） | [使用 Salesforce CRM 源连接器摄取数据](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/ingest-data-from-adobe-analytics.html?lang=zh-Hans) | 视频 | 通过 Salesforce CRM 源连接器，您可以采用一种无缝且可扩展的方式，轻松地将数据从 Salesforce CRM 批量摄取到 Adobe Experience Platform 的实时客户资料和 Experience 数据湖中。 |
...
有关更多详细信息，请参阅[使用桌面应用程序添加资产](https://experienceleague.adobe.com/docs/experience-manager-desktop-app/using/using.html?lang=zh-Hans#upload-and-add-new-assets-to-aem)。
   ...
   * **Cloud Manager**
      ...
      * 对 [SSL 证书](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/onboarding/getting-access/manage-ssl-certificates/introduction.html?lang=zh-Hans)和[自定义域名](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/onboarding/getting-access/custom-domain-names/introduction.html?lang=zh-Hans)实施自助服务管理。
      * 对 [IP 允许列表](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/onboarding/getting-access/ip-allow-lists/introduction.html?lang=zh-Hans)实施自助服务管理。
...
| 发布日期 | 名称 | 类型 | 描述 |
| -----------| ---------- | ---------- | ---------- |
| 2020 年 12 月 7 日 | [使用片段引用进行高级数据建模](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/fragment-references.html?lang=zh-Hans) | 文章 | 开始使用 Adobe Experience Manager (AEM) 和 GraphQL。了解如何使用[!UICONTROL 片段引用]功能实现高级数据建模，并在两个不同的[!UICONTROL 内容片段]之间创建联系。了解如何修改 GraphQL 查询，以包含引用模型中的字段。 |
| 2020 年 12 月 7 日 | [使用 GraphQL 从外部应用程序中查询 AEM](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/explore-graphql-api.html?lang=zh-Hans) | 文章 | 开始使用 Adobe Experience Manager (AEM) 和 GraphQL。浏览 AEM 的 GraphQL API 示例（WKND GraphQL React 应用程序）。了解此外部应用程序如何通过对 AEM 实施 GraphQL 调用来提升其体验。了解如何处理基本错误。 |
...
| 2020 年 12 月 | [创作内容片段](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/author-content-fragments.html?lang=zh-Hans) | 文章 | 开始使用 Adobe Experience Manager (AEM) 和 GraphQL。根据[!UICONTROL 内容片段模型]创建和编辑新的内容片段。了解如何创建[!UICONTROL 内容片段]的变体。 |
| 2020 年 12 月 7 日 | [定义内容片段模型](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/content-fragment-models.html?lang=zh-Hans) | 文章 | 开始使用 Adobe Experience Manager (AEM) 和 GraphQL。了解如何在 AEM 中使用“内容片段模型”建立内容模型和构建模式。检查现有模型并创建新模型。了解可用于定义模式的不同数据类型。 |
| 2020 年 12 月 9 日 | [API 兼容性](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/developer-reference-material-apis.html?lang=zh-Hans) | 文章 | 编写一篇简单的文章，文中明确说明哪些 AEM API（npm、Java、HTTP）可用于各种 [!UICONTROL Assets] 操作。 |
...
| 2020 年 12 月 16 日 | [Dynamic Media 核心组件](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/dynamic-media/dynamic-media-core-components.html?lang=zh-Hans) | 视频 | 图像组件是 Experience Manager 核心组件的一部分，可对 Dynamic Media 提供内置支持。了解图像组件如何允许内容作者在 AEM Sites 页面上使用 Dynamic Media 的功能（如图像预设、智能裁剪和图像修改工具）。 |
...
| 2020 年 12 月 4 日 | [使用 Adobe PDF Tools API 对 PDF 文件进行光学字符识别 (OCR)](https://experienceleague.adobe.com/docs/document-services/document-services/tutorials/ocr.html?lang=zh-Hans) | 文章 | 了解如何使用[!UICONTROL 光学字符识别]解锁扫描的 PDF，以提取文本并创建可搜索的文件。 |
| 2020 年 12 月 4 日 | [Adobe PDF Tools API 和 Java 快速入门](https://experienceleague.adobe.com/docs/document-services/document-services/tutorials/gettingstartedjava.html?lang=zh-Hans) | 文章 | 开发人员只需几分钟即可快速入门，并可以运行为访问所有可用的 Web 服务而提供的示例文件。本教程将指导您完成所有步骤，以便您开始使用 PDF Tools Java SDK 来运行示例。 |
| 2020 年 12 月 4 日 | [Adobe PDF Tools API 和 .Net 快速入门](https://experienceleague.adobe.com/docs/document-services/document-services/tutorials/gettingstartednet.html?lang=zh-Hans) | 文章 | 开发人员只需几分钟即可快速入门，并可以运行为访问所有可用的 Web 服务而提供的示例文件。本教程将指导您完成所有步骤，以便您开始使用 PDF Tools .Net SDK 来运行示例。 |
| 2020 年 12 月 4 日 | [利用 PDF Tools API 将 PDF 转换为Word、PowerPoint 等](https://experienceleague.adobe.com/docs/document-services/document-services/tutorials/exportpdf.html?lang=zh-Hans) | 文章 | 将 PDF 文件转换为 MS Word，以编辑内容、审批后发送以供签名，从而创建自定义合同工作流。或者，将 PDF 内容导出为 MS Excel 格式，以便进行发票、财务计算或数据分析。 |
| 2020 年 12 月 4 日 | [使用 PDF Tools API 和 Node.js 在几分钟内从 HTML 或 MS Office 中创建 PDF](https://experienceleague.adobe.com/docs/document-services/document-services/tutorials/createpdffromhtml.html?lang=zh-Hans) | 文章 | 了解如何使用新的 Adobe PDF Tools API 实现数字化文档工作流。此 API 为开发人员提供了自由选择的范围，让他们可以在多种功能强大的 PDF 处理服务中选择，以满足复杂的业务工作流的需求。 |
