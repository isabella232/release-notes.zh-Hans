...
有关适用于以下对象的最新更新，请参阅 [Experience Platform 发行说明](https://docs.adobe.com/content/help/zh-Hans/experience-platform/release-notes/latest.html)：
...
| 更新Ad Hoc Analysis Java™ 8兼容性 | 2020 年 8 月 21 日 | Ad Hoc Analysis当前与Java™ 8版本1.8.0_261+不兼容。 为确保在达到[生命周期结束日期](https://spark.adobe.com/page/S9Bhp66VJ2fEn/)之前不会中断对此工具的访问，Adobe建议您维护1.8.0_261之前的Java™ 8版本。 |
| Adobe Data Connectors 生命周期终止 | 2020 年 7 月 13 日 | Adobe [!UICONTROL Data Connectors] 由传统技术提供支持，而这些技术不再可行或不再受支持。Adobe在[AdobeExchange合作伙伴计划](https://partners.adobe.com/exchangeprogram/experiencecloud)中采用了新标准，任何希望继续提供和支持的集成应采用该标准。 正式的生命周期终止日期仍有待确定，但Adobe预计将在未来12-18个月（2021年中至2021年底）内确定。 [了解详情...](https://experienceleague.adobe.com/docs/analytics/import/dataconnectors/data-connectors-eol.html?lang=zh-Hans) |
...
Experience Manager6.4 Service Pack 8累积修补程序包3（即2020年11月26日发布的6.4.8.3版）是一项重要更新，其中包括自2020年3月推出Experience Manager6.4 Service Pack 8(6.4.8.0)通用版本以来进行的多项内部修补程序和客户修补程序。
...
有关更多详细信息，请参阅[使用桌面应用程序添加资产](https://experienceleague.adobe.com/docs/experience-manager-desktop-app/using/using.html?lang=zh-Hans#upload-and-add-new-assets-to-aem)。
   ...
   * **Cloud Manager**
      ...
      * 对[SSL证书](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/manage-ssl-certificates/introduction.html)和[自定义域名](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/custom-domain-names/introduction.html)进行自助服务管理。
      * 对[IP允许列表](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/ip-allow-lists/introduction.html)进行自助服务管理。
...
有关此增效工具的更多详细信息，请参阅[统一体验](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/refactoring-tools/unified-experience.html?lang=zh-Hans#benefits)。
      * 索引转换器是一个实用程序，可用于将客户的自定义OAK索引定义转换为Experience Manager为与Cloud Service兼容的OAK索引定义。
...
* **Best Practices Analyzer**
   ...
   * [!UICONTROL Cloud Readiness Analyzer] 现在更名为 [!UICONTROL Best Practices Analyzer] (BPA)。BPA为您当前的Experience Manager实施提供最佳实践评估，并帮助评估从现有AEM实例移动到AEM as a [!UICONTROL Cloud Service]的准备情况。
...
| 2020 年 12 月 9 日 | [API 兼容性](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/developer-reference-material-apis.html?lang=zh-Hans) | 文章 | 创建一篇简单的文章，文章中明确说明哪些AEM API(npm、Java™、HTTP)可用于各种[!UICONTROL Assets]操作。 |
...
| 2020 年 12 月 16 日 | [Dynamic Media 核心组件](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/dynamic-media/dynamic-media-core-components.html?lang=zh-Hans) | 视频 | 图像组件是 Experience Manager 核心组件的一部分，可对 Dynamic Media 提供内置支持。了解图像组件如何允许内容作者在“Experience Manager站点”页面上使用Dynamic Media的功能，如图像预设、智能裁剪和图像修改工具。 |
...
* [AEM as a Cloud Service 发行信息](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/home.html?lang=en)
* [AEM Cloud Manager 发行说明](https://experienceleague.adobe.com/docs/experience-manager-cloud-manager/using/release-notes/release-notes-current.html?lang=en)
...
* [AEM as a Cloud Service 指南](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/landing/home.html?lang=en)
...
| 功能 | 描述 |
| -----------| ---------- |
| 新建帮助 | （10月28日版）旧版帮助页面已替换为更新页面，更新页面可从DSP主菜单的“帮助”链接获取，也始终从[https://experienceleague.adobe.com/docs/advertising-cloud/dsp/home.html](https://experienceleague.adobe.com/docs/advertising-cloud/dsp/home.html?lang=zh-Hans)获取 |
...
请参阅 [!DNL Marketo] [发行说明](https://docs.marketo.com/display/public/DOCS/Release+Notes%3A+7月+%2720)了解最新发行信息。
