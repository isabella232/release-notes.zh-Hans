...
* [Experience Platform 发行说明](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html)。（2021 年 1 月 27 日）
...
| ----------- | ---------- | ------- |
| 数据修复API更新 | 2021 年 3 月 25 日 | 在API工具中添加了一系列新脚本以删除或编辑Adobe Analytics数据，包括保留变量、特殊变量、设置新值、值匹配和处理URL。 |
...
* **Experience Manager 即云服务**
   ...
   * **Experience Manager Sites as a Cloud Service**
      ...
      * **渐进式 Web 应用程序 (PWA)**
         ...
         * 现在只需进行简单的配置，即可在项目级别启用[网站的渐进式 Web 应用程序 (PWA) 版本](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/features/enable-pwa.html)。
   * **Experience Manager Assets 即云服务**

      * Experience Manager资产作为Cloud Service，有权使用预配置的Brand Portal实例。 Cloud Manager用户可以将Experience Manager资产上的Brand Portal激活为Cloud Service。 请参阅[激活Brand Portal](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/brand-portal/configure-aem-assets-with-brand-portal.html)。

      * 企业现在可以使用Brand Portal来源资产。 资产来源收集功能利用品牌门户来帮助客户与代理用户互动，为新的营销活动、照片和项目寻找资产。 请参阅Brand Portal中的[资产来源补充](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/asset-sourcing-in-brand-portal/brand-portal-asset-sourcing.html)。

      * 现在，品牌门户使用情况报告仅显示活动用户。 不活动的用户现在不显示。 活动用户是指将其帐户分配给Admin Console中的产品用户档案的用户。 请参阅[品牌门户报告](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/admin-tools/brand-portal-reports.html)。

      * 在Brand Portal中，引入了新的下载设置，允许您在下载文件夹、收藏集等时为每个资产创建单独的文件夹。 请参阅[下载设置](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/download/brand-portal-download-assets.html)。
