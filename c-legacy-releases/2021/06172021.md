...
| 功能 | 日期 | 描述 |
| ------- | ------- | ------- |
| Adobe Federated ID 支持单点登录 | 2021 年 6 月 17 日 | 如果您使用 Federated ID，则无需输入电子邮件地址或密码即可登录到 Experience Cloud。要使用此功能，请将&#x200B;**#/sso:@domain**&#x200B;添加到Experience CloudURL。 <br><br>例如，假定您拥有域 **adobecustomer.** com，并且想要登录Adobe Analytics。URL应为：**https://experience.adobe.com/#/sso:@adobecustomer.com/analytics**。 |
| Experience League 搜索 | 2021 年 6 月 1 日 | Experience League 文档搜索已改进。导航到 [Experience League](https://experienceleague.adobe.com/docs/?lang=en)，使用&#x200B;**[!UICONTROL 搜索]**&#x200B;字段找到教程、文档和课程等。 |
