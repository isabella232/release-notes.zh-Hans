...
请参阅[内容审核测试](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/test-results/content-audit-testing.html)。
...
| 2020 年 8 月 12 日 | [AEM as a Cloud Service SDK 的本地开发](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/commerce/develop.html) | 视频 | 了解如何设置 [!UICONTROL AEM Commerce] 和 [!UICONTROL AEM as a Cloud Service] SDK 的本地开发环境。 |
