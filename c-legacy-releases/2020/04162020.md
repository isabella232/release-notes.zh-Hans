...
* 修复了导致为包含移动设备 ID 的区段报告的[可寻址受众](https://docs.adobe.com/content/help/zh-Hans/audience-manager/user-guide/features/addressable-audiences.html)不准确的问题。在此更新之后，您可能会看到[可寻址受众](https://docs.adobe.com/content/help/en/audience-manager/user-guide/features/addressable-audiences.html)有所增加。
...
| [Java 内容存储库 (JCR) 简介](https://docs.adobe.com/content/help/en/experience-manager-learn/cloud-service/underlying-technology/introduction-jcr.html) | Adobe Experience Manager使用的Java内容存储库(JCR)简介。 |
